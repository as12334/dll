...
public class m_cl_10_pk10 : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            string str = "_m_pk10_lmcl";
            string str2 = "_m_pk10_cql";
            ...
            if (!string.IsNullOrEmpty(str6) && ((str6 == "21") || (str6 == "18")))
            {
                ...
                {
                    List<string> list2 = CallBLL.cz_phase_pk10_bll.PaihangList_LMP("pk10_lmp", 10);
