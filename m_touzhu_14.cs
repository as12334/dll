...
public class m_touzhu_14 : MemberPageBase_Mobile
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.r_url = "JSSFC_" + this.wanfa + ".aspx?lottery_type=" + this.caizhong + "&player_type=" + this.wanfa;
        DataTable table = CallBLL.cz_phase_jssfc_bll.GetIsClosedByTime(int.Parse(this.jiangqi)).Tables[0];
        ...
        DataSet playOddsByID = CallBLL.cz_odds_jssfc_bll.GetPlayOddsByID(str2);
