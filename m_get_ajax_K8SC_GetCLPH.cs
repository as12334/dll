...
public class m_get_ajax_K8SC_GetCLPH : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            int num;
            string str = "_m_k8sc_lmcl";
            string str2 = "_m_k8sc_cql";
            string str3 = "_m_k8sc_lryl";
            ...
            if (!string.IsNullOrEmpty(str7))
            {
                ...
                if ((str7 == "17") || (str7 == "24"))
                {
                    ...
                    {
                        list2 = CallBLL.cz_phase_k8sc_bll.PaihangList_LMP(str7, 10);
                ...
                else
                {
                    ...
                    if (Utils.IsNumeric(str9))
                    {
                        ...
                        {
                            list2 = CallBLL.cz_phase_k8sc_bll.PaihangListDQ(str9, 10);
            ...
            if (((!string.IsNullOrEmpty(str10) && Utils.IsNumeric(str10)) && (int.Parse(str10) > 0)) && (int.Parse(str10) <= 5))
            {
                ...
                {
                    DataSet lRYL = CallBLL.cz_phase_k8sc_bll.GetLRYL(str10);
