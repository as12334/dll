...
public class m_cl_10_happycar : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            string str = "_m_happycar_lmcl";
            string str2 = "_m_happycar_cql";
            ...
            if (!string.IsNullOrEmpty(str6) && ((str6 == "21") || (str6 == "18")))
            {
                ...
                {
                    List<string> list2 = CallBLL.cz_phase_happycar_bll.PaihangList_LMP("happycar_lmp", 10);
