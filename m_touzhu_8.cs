...
public class m_touzhu_8 : MemberPageBase_Mobile
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.numTable = Utils.GetPKBJL_NumTable(this.player_type);
        this.playtype = LSRequest.qq("playtype");
        if (!string.IsNullOrEmpty(this.playtype) && ((this.playtype != "0") && (this.playtype != "1")))
        {
            base.Response.End();
        }
        else
        {
            if (((((this.caizhong == "") || (this.wanfa == "")) || ((this.jiangqi == "") || (this.data_str == ""))) || (this.txtMomey == "")) || (this.numTable == ""))
            {
                base.Response.End();
            }
            this.r_url = "PKBJL_" + this.wanfa + ".aspx?lottery_type=" + this.caizhong + "&player_type=" + this.wanfa;
            DataTable table = CallBLL.cz_phase_pkbjl_bll.GetIsClosedByTime(int.Parse(this.jiangqi), this.numTable).Tables[0];
            ...
            DataSet playOddsByID = CallBLL.cz_odds_pkbjl_bll.GetPlayOddsByID(str2);
