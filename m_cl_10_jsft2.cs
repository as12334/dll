...
public class m_cl_10_jsft2 : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            string str = "_m_jsft2_lmcl";
            string str2 = "_m_jsft2_cql";
            ...
            if (!string.IsNullOrEmpty(str6) && ((str6 == "21") || (str6 == "18")))
            {
                ...
                {
                    List<string> list2 = CallBLL.cz_phase_jsft2_bll.PaihangList_LMP("jsft2_lmp", 10);
