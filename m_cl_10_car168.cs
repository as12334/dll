...
public class m_cl_10_car168 : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            string str = "_m_car168_lmcl";
            string str2 = "_m_car168_cql";
            ...
            if (!string.IsNullOrEmpty(str6) && ((str6 == "21") || (str6 == "18")))
            {
                ...
                {
                    List<string> list2 = CallBLL.cz_phase_car168_bll.PaihangList_LMP("car168_lmp", 10);
