...
public class m_L_Confirm_Jeu_pkbjl : MemberPageBase_Mobile
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string str7 = "PKBJL_" + str5 + ".aspx?lottery_type=" + str4 + "&player_type=" + str5;
        string str8 = "";
        string str9 = "";
        string str10 = "";
        string str11 = "";
        ...
        string s = "";
        string str14 = "";
        s = Utils.GetPKBJL_NumTable(LSRequest.qq("player_type"), "");
        str14 = LSRequest.qq("playtype");
        ...
        if ((int.Parse(s) < 1) || (int.Parse(s) > 5))
        {
            base.DeleteCreditLock(str);
            base.Response.End();
        }
    ...
    Label_06E4:;
        ...
        string str19 = "";
        string str20 = "";
        if (!Utils.IsInteger(str17))
        {
            base.Response.End();
        }
        DataTable table2 = CallBLL.cz_phase_pkbjl_bll.GetIsClosedByTime(int.Parse(str17), s).Tables[0];
        if ((table2 != null) && (table2.Rows.Count > 0))
        {
            ...
            str19 = table2.Rows[0]["phase"].ToString();
            str20 = table2.Rows[0]["p_id"].ToString();
            time = Convert.ToDateTime(table2.Rows[0]["stop_date"].ToString());
            num30 = 8;
            string str21 = base.BetReceiveEnd(num30.ToString());
            if (!string.IsNullOrEmpty(str21))
            {
                time = Convert.ToDateTime(table2.Rows[0]["play_open_date"].ToString()).AddSeconds((double) -int.Parse(str21));
            }
        }
        else
        {
        ...
        str22 = table3.Rows[0]["kc_kind"].ToString().Trim().ToUpper();
        str23 = table3.Rows[0]["su_type"].ToString().Trim();
        num5 = double.Parse(table3.Rows[0]["kc_usable_credit"].ToString().Trim());
        getUserModelInfo.set_kc_kind(str22.ToUpper());
        string str24 = "0";
        string str25 = "0";
        string str26 = "0";
        string str27 = "0";
        ...
        DataTable plDT = CallBLL.cz_odds_pkbjl_bll.GetPlayOddsByID(str9).Tables[0];
        ...
        {
            DataTable table5 = CallBLL.cz_bet_kc_bll.GetSinglePhaseByBet(str19, str, num2.ToString(), str9, null).Tables[0];
            ...
            else
            {
                ...
                int num13 = 0;
                foreach (string str36 in strArray3)
                {
                    num6 = 0.0;
                    row = plDT.Select(string.Format(" odds_id= {0} ", str36.Trim()))[0];
                    str35 = row["is_open"].ToString().Trim();
                    str31 = row["current_odds"].ToString().Trim();
                    str32 = row[str22 + "_diff"].ToString().Trim();
                    str30 = row["play_id"].ToString().Trim();
                    str33 = row["play_name"].ToString().Trim();
                    str34 = row["put_amount"].ToString().Trim();
                    ...
                    {
                        DataRow[] rowArray2 = table5.Select(string.Format(" odds_id = {0} ", str36.Trim()));
                    ...
                    {
                        if (CacheHelper.GetCache("kc_drawback_FileCacheKey_pkbjl" + str30 + this.Session["user_name"].ToString()) == null)
                        {
                            table6 = CallBLL.cz_drawback_pkbjl_bll.GetDrawback(str30, str).Tables[0];
                        }
                        else
                        {
                            table6 = base.GetUserDrawback_pkbjl(rate, getUserModelInfo.get_kc_kind(), str30);
                        }
                    }
                    ...
                    DataRow[] rowArray3 = table6.Select(string.Format(" play_id={0} and u_name='{1}' ", str30, str));
                    ...
                    {
                        base.DeleteCreditLock(str);
                        base.Response.Write("<script>alert('" + str33 + "【" + str34 + "】已經停止投注！！');$('#JeuValidate').val('" + base.get_JeuValidate() + "');</script>");
                        base.Response.End();
                    }
                    num12 = double.Parse(str31) + double.Parse(str32);
                    string pl = num12.ToString();
                    base.GetOdds_KC(8, str36, ref pl);
                    num12 = Convert.ToDouble(pl);
                    if (str14.Equals("0"))
                    {
                        num12 = Utils.GetPKBJLPlaytypeOdds(str36, num12, base.GetPlayTypeWTValue_PKBJL(str36));
                    }
                    ...
                    {
                        base.DeleteCreditLock(str);
                        base.Response.Write("<script>alert('" + str33 + "【" + str34 + "】賠率已經由 " + strArray4[num13] + " 變為 " + num12.ToString() + " 請確認再投註！');$('#v_" + strArray[num13] + " ~ span.hong').text('" + num12.ToString() + "');$('#p_" + strArray[num13] + "').val('" + num12.ToString() + "');$('#JeuValidate').val('" + base.get_JeuValidate() + "');</script>");
                        base.Response.End();
                        return;
                    }
                    ...
                    {
                        base.DeleteCreditLock(str);
                        base.Response.Write("<script>alert('" + str33 + "【" + str34 + "】下註單期金額超出單期最大金額！');</script>");
                        base.Response.End();
                        return;
                    }
                    num13++;
                ...
                double num15 = 0.0;
                int num16 = 0;
                foreach (string str38 in strArray3)
                {
                ...
                else
                {
                    ...
                    foreach (string str36 in strArray3)
                    {
                        ...
                        {
                            num30 = 8;
                            base.Add_Bet_Lock(num30.ToString(), getUserModelInfo.get_zjname(), str36);
                        }
                        DataTable table8 = CallBLL.cz_odds_pkbjl_bll.GetOddsByID(str36).Tables[0];
                        int num17 = int.Parse(table8.Rows[0]["play_id"].ToString());
                        string str39 = table8.Rows[0]["play_name"].ToString();
                        string str40 = table8.Rows[0]["put_amount"].ToString();
                        string ratio = table8.Rows[0]["ratio"].ToString();
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            dataTable = base.GetUserDrawback_pkbjl(rate, getUserModelInfo.get_kc_kind(), num17.ToString());
                        }
                        else
                        {
                        ...
                        if (dataTable == null)
                        {
                            ...
                            {
                                num30 = 8;
                                base.Un_Bet_Lock(num30.ToString(), getUserModelInfo.get_zjname(), str36);
                            }
                            else
                            {
                                num30 = 8;
                                base.Un_Bet_Lock(num30.ToString(), rate.get_fgsname(), str36);
                            }
                        ...
                        {
                            string str45 = row["u_type"].ToString().Trim();
                            if (str45 != null)
                            {
                                if (!(str45 == "zj"))
                                {
                                ...
                                {
                                    str24 = row[str22 + "_drawback"].ToString().Trim();
                                }
                            }
                            continue;
                        Label_164A:
                            str25 = row[str22 + "_drawback"].ToString().Trim();
                            continue;
                        Label_166E:
                            str26 = row[str22 + "_drawback"].ToString().Trim();
                            continue;
                        Label_1692:
                            str27 = row[str22 + "_drawback"].ToString().Trim();
                            continue;
                        Label_16B6:
                            str28 = row[str22 + "_drawback"].ToString().Trim();
                            continue;
                        Label_16DA:
                            if (getUserModelInfo.get_su_type() == "dl")
                            {
                                str29 = row[str22 + "_drawback"].ToString().Trim();
                            }
                        ...
                        {
                            num30 = 8;
                            base.Add_Bet_Lock(num30.ToString(), rate.get_fgsname(), str36);
                        }
                        double num33 = double.Parse(table8.Rows[0]["current_odds"].ToString()) + Convert.ToDouble(table8.Rows[0][str22 + "_diff"].ToString().Trim());
                        string str42 = num33.ToString();
                        if (str14.Equals("0"))
                        {
                            str42 = Utils.GetPKBJLPlaytypeOdds(str36, double.Parse(str42), base.GetPlayTypeWTValue_PKBJL(str36)).ToString();
                        }
                        string str43 = str42.ToString();
                        base.GetOdds_KC(8, str36, ref str43);
                        double playDrawbackValue = base.GetPlayDrawbackValue(str25, ratio);
                        if ((playDrawbackValue != 0.0) && (double.Parse(str42) > playDrawbackValue))
                        {
                            base.DeleteCreditLock(str);
                            if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                            {
                        ...
                        _kc.set_odds_zj(str42);
                        _kc.set_isPhone(1);
                        _kc.set_table_type(new int?(int.Parse(s)));
                        _kc.set_play_type(new int?(int.Parse(str14)));
                        int num22 = 0;
                        ...
                        CallBLL.cz_odds_pkbjl_bll.UpdateGrandTotal(Convert.ToDecimal(num23), int.Parse(str36));
                        ...
                        if ((num26 >= 1.0) && (num25 >= 1.0))
                        {
                            ...
                            int num29 = CallBLL.cz_odds_pkbjl_bll.UpdateGrandTotalCurrentOdds(num27.ToString(), (num23 - (num25 * num26)).ToString(), str36);
                            ...
                            _log.set_play_name(str39);
                            _log.set_put_amount(str40);
                            num30 = 8;
                            _log.set_l_name(base.GetGameNameByID(num30.ToString()));
                            _log.set_l_phase(str19);
                            _log.set_action("降賠率");
                            _log.set_odds_id(int.Parse(str36));
                            string str44 = table8.Rows[0]["current_odds"].ToString();
                            _log.set_old_val(str44);
                            num33 = double.Parse(str44) - num27;
                            ...
                            _odds.set_odds_id(int.Parse(str36));
                            _odds.set_phase_id(int.Parse(str20));
                            _odds.set_play_name(str39);
                            _odds.set_put_amount(str40);
                            _odds.set_odds(num27.ToString());
                            _odds.set_lottery_type(8);
                            _odds.set_phase(str19);
                            _odds.set_old_odds(str44);
                            _odds.set_new_odds((double.Parse(str44) - num27).ToString());
                        ...
                        CallBLL.cz_autosale_pkbjl_bll.DLAutoSale(_kc.get_order_num(), str12, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str22, table8.Rows[0]["play_id"].ToString(), str36.Trim(), str24, str25, str26, str27, str28, str29, str20, str19, _kc.get_ip(), num2, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable, s, str14);
                        if (getUserModelInfo.get_kc_op_odds().Equals(1))
                        {
                            fgsWTTable = base.GetFgsWTTable(8);
                        }
                        CallBLL.cz_autosale_pkbjl_bll.ZDAutoSale(_kc.get_order_num(), str12, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str22, table8.Rows[0]["play_id"].ToString(), str36.Trim(), str24, str25, str26, str27, str28, str29, str20, str19, _kc.get_ip(), num2, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable, s, str14);
                        if (getUserModelInfo.get_kc_op_odds().Equals(1))
                        {
                            fgsWTTable = base.GetFgsWTTable(8);
                        }
                        CallBLL.cz_autosale_pkbjl_bll.GDAutoSale(_kc.get_order_num(), str12, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str22, table8.Rows[0]["play_id"].ToString(), str36.Trim(), str24, str25, str26, str27, str28, str29, str20, str19, _kc.get_ip(), num2, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable, s, str14);
                        if (getUserModelInfo.get_kc_op_odds().Equals(1))
                        {
                            fgsWTTable = base.GetFgsWTTable(8);
                        }
                        CallBLL.cz_autosale_pkbjl_bll.FGSAutoSale(_kc.get_order_num(), str12, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str22, table8.Rows[0]["play_id"].ToString(), str36.Trim(), str24, str25, str26, str27, str28, str29, str20, str19, _kc.get_ip(), num2, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable, s, str14);
                        if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                        {
                            num30 = 8;
                            base.Un_Bet_Lock(num30.ToString(), getUserModelInfo.get_zjname(), str36);
                        ...
                        {
                            base.Un_Bet_Lock(8.ToString(), rate.get_fgsname(), str36);
                        }
                        num13++;
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            base.SetUserDrawback_pkbjl(dataTable, num17.ToString());
                        }
                    }
