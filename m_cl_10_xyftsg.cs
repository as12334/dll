...
public class m_cl_10_xyftsg : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            string str = "_m_xyftsg_lmcl";
            string str2 = "_m_xyftsg_cql";
            ...
            if (!string.IsNullOrEmpty(str6) && ((str6 == "21") || (str6 == "18")))
            {
                ...
                {
                    List<string> list2 = CallBLL.cz_phase_xyftsg_bll.PaihangList_LMP("xyftsg_lmp", 10);
