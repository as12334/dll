...
public class m_touzhu_4 : MemberPageBase_Mobile
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((((this.caizhong == "") || (this.jiangqi == "")) || (this.data_str == "")) || (this.txtMomey == ""))
        {
            base.Response.End();
        }
        this.r_url = "JSK3" + this.wanfa + ".aspx?lottery_type=" + this.caizhong + "&player_type=" + this.wanfa;
        DataTable table = CallBLL.cz_phase_jsk3_bll.GetIsClosedByTime(int.Parse(this.jiangqi)).Tables[0];
        ...
        DataSet playOddsByID = CallBLL.cz_odds_jsk3_bll.GetPlayOddsByID(str2);
