...
public class m_touzhu_18 : MemberPageBase_Mobile
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.r_url = "VRCAR_" + this.wanfa + ".aspx?lottery_type=" + this.caizhong + "&player_type=" + this.wanfa;
        DataTable table = CallBLL.cz_phase_vrcar_bll.GetIsClosedByTime(int.Parse(this.jiangqi)).Tables[0];
        ...
        DataSet playOddsByID = CallBLL.cz_odds_vrcar_bll.GetPlayOddsByID(str2);
