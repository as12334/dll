...
public class m_cl_10_jspk10 : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            string str = "_m_jspk10_lmcl";
            string str2 = "_m_jspk10_cql";
            ...
            if (!string.IsNullOrEmpty(str6) && ((str6 == "21") || (str6 == "18")))
            {
                ...
                {
                    List<string> list2 = CallBLL.cz_phase_jspk10_bll.PaihangList_LMP("jspk10_lmp", 10);
