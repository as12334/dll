...
public class m_L_Confirm_Jeu_speed5 : MemberPageBase_Mobile
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string str7 = "SPEED5_" + str5 + ".aspx?lottery_type=" + str4 + "&player_type=" + str5;
        string str8 = "";
        string str9 = "";
        string str10 = "";
        string str11 = "";
    ...
    Label_05F5:;
        ...
        DataTable plDT = CallBLL.cz_odds_speed5_bll.GetPlayOddsByID(str9).Tables[0];
        ...
        else
        {
            ...
            else
            {
                ...
                foreach (string str33 in strArray3)
                {
                    ...
                    {
                        if (CacheHelper.GetCache("kc_drawback_FileCacheKey_speed5" + str27 + this.Session["user_name"].ToString()) == null)
                        {
                            table6 = CallBLL.cz_drawback_speed5_bll.GetDrawback(str27, str).Tables[0];
                        }
                        else
                        {
                            table6 = base.GetUserDrawback_speed5(rate, getUserModelInfo.get_kc_kind(), str27);
                        }
                    }
                    ...
                    {
                        table6 = base.GetUserDrawback_speed5(rate, getUserModelInfo.get_kc_kind());
                    }
                    ...
                    base.GetOdds_KC(11, str33, ref pl);
                ...
                else
                {
                    ...
                    foreach (string str33 in strArray3)
                    {
                        ...
                        DataTable table8 = CallBLL.cz_odds_speed5_bll.GetOddsByID(str33).Tables[0];
                        ...
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            dataTable = base.GetUserDrawback_speed5(rate, getUserModelInfo.get_kc_kind(), num17.ToString());
                        }
                        else
                        {
                            dataTable = base.GetUserDrawback_speed5(rate, getUserModelInfo.get_kc_kind());
                        }
                        if (dataTable == null)
                        {
                            base.DeleteCreditLock(str);
                        ...
                        base.GetOdds_KC(11, str33, ref str40);
                        ...
                        CallBLL.cz_odds_speed5_bll.UpdateGrandTotal(Convert.ToDecimal(num23), int.Parse(str33));
                        ...
                        if ((num26 >= 1.0) && (num25 >= 1.0))
                        {
                            ...
                            int num29 = CallBLL.cz_odds_speed5_bll.UpdateGrandTotalCurrentOdds(num27.ToString(), (num23 - (num25 * num26)).ToString(), str33);
                        ...
                        CallBLL.cz_autosale_speed5_bll.DLAutoSale(_kc.get_order_num(), str12, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str19, table8.Rows[0]["play_id"].ToString(), str33.Trim(), str21, str22, str23, str24, str25, str26, str17, str16, _kc.get_ip(), num2, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                        if (getUserModelInfo.get_kc_op_odds().Equals(1))
                        {
                            fgsWTTable = base.GetFgsWTTable(11);
                        }
                        CallBLL.cz_autosale_speed5_bll.ZDAutoSale(_kc.get_order_num(), str12, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str19, table8.Rows[0]["play_id"].ToString(), str33.Trim(), str21, str22, str23, str24, str25, str26, str17, str16, _kc.get_ip(), num2, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                        if (getUserModelInfo.get_kc_op_odds().Equals(1))
                        {
                            fgsWTTable = base.GetFgsWTTable(11);
                        }
                        CallBLL.cz_autosale_speed5_bll.GDAutoSale(_kc.get_order_num(), str12, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str19, table8.Rows[0]["play_id"].ToString(), str33.Trim(), str21, str22, str23, str24, str25, str26, str17, str16, _kc.get_ip(), num2, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                        if (getUserModelInfo.get_kc_op_odds().Equals(1))
                        {
                            fgsWTTable = base.GetFgsWTTable(11);
                        }
                        CallBLL.cz_autosale_speed5_bll.FGSAutoSale(_kc.get_order_num(), str12, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str19, table8.Rows[0]["play_id"].ToString(), str33.Trim(), str21, str22, str23, str24, str25, str26, str17, str16, _kc.get_ip(), num2, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                        if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                        {
                            num30 = 11;
                            base.Un_Bet_Lock(num30.ToString(), getUserModelInfo.get_zjname(), str33);
                        ...
                        {
                            base.Un_Bet_Lock(11.ToString(), rate.get_fgsname(), str33);
                        }
                        num13++;
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            base.SetUserDrawback_speed5(dataTable, num17.ToString());
                        }
                    }
