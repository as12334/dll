...
public class m_cl_10_jssfc : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            ArrayList list3;
            string str = "_m_jssfc_lmcl";
            string str2 = "_m_jssfc_cql";
            string str3 = "_m_jssfc_lryl";
            ...
            {
                DataTable table = CallBLL.cz_phase_jssfc_bll.GetChangLong().Tables[0];
            ...
            if (!string.IsNullOrEmpty(str7))
            {
                ...
                if (str7 == "16")
                {
                    ...
                    {
                        paiHang = CallBLL.cz_phase_jssfc_bll.GetPaiHang(str8, 10);
            ...
            if (((!string.IsNullOrEmpty(str10) && Utils.IsNumeric(str10)) && (int.Parse(str10) > 0)) && (int.Parse(str10) <= 8))
            {
                ...
                {
                    DataSet lRYL = CallBLL.cz_phase_jssfc_bll.GetLRYL(str10);
