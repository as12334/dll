namespace User.Web.L_VRSSC.Handler
{
    ...
    public class Handler : BaseHandler
    {
        ...
        public void do_put_money(HttpContext context, ref string strResult)
        {
            ...
            if (source.Length > FileCacheHelper.get_GetVRSSCMaxGroup())
            {
                base.DeleteCreditLock(str);
                result.set_success(400);
                result.set_tipinfo(string.Format("您選擇的號碼超過了最大{0}組，請重新選擇號碼!", FileCacheHelper.get_GetVRSSCMaxGroup()));
                dictionary.Add("JeuValidate", base.get_JeuValidate());
                result.set_data(dictionary);
                strResult = JsonHandle.ObjectToJson(result);
                return;
        ...
        Label_04F7:;
            ...
            DataTable table2 = CallBLL.cz_phase_vrssc_bll.GetIsClosedByTime(int.Parse(s)).Tables[0];
            ...
            DataTable plDT = CallBLL.cz_odds_vrssc_bll.GetPlayOddsByID(str4).Tables[0];
            ...
            else
            {
                ...
                else
                {
                    ...
                    foreach (string str22 in strArray3)
                    {
                        ...
                        {
                            if (CacheHelper.GetCache("kc_drawback_FileCacheKey_vrssc" + str16 + this.Session["user_name"].ToString()) == null)
                            {
                                table6 = CallBLL.cz_drawback_vrssc_bll.GetDrawback(str16, str).Tables[0];
                            }
                            else
                            {
                                table6 = base.GetUserDrawback_vrssc(_rate, getUserModelInfo.get_kc_kind(), str16);
                            }
                        }
                        else if (CacheHelper.GetCache("kc_drawback_FileCacheKey_vrssc" + this.Session["user_name"].ToString()) == null)
                        {
                            table6 = CallBLL.cz_drawback_vrssc_bll.GetDrawback(str16, str).Tables[0];
                        }
                        else
                        {
                            table6 = base.GetUserDrawback_vrssc(_rate, getUserModelInfo.get_kc_kind());
                        }
                        ...
                        base.GetOdds_KC(0x13, str22, ref pl);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            foreach (string str22 in strArray3)
                            {
                                ...
                                DataTable table8 = CallBLL.cz_odds_vrssc_bll.GetOddsByID(str22).Tables[0];
                                ...
                                if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                                {
                                    dataTable = base.GetUserDrawback_vrssc(_rate, getUserModelInfo.get_kc_kind(), str25.ToString());
                                }
                                else
                                {
                                    dataTable = base.GetUserDrawback_vrssc(_rate, getUserModelInfo.get_kc_kind());
                                }
                                if (dataTable == null)
                                {
                                    base.DeleteCreditLock(str);
                                ...
                                base.GetOdds_KC(0x13, str22, ref str37);
                                ...
                                CallBLL.cz_odds_vrssc_bll.UpdateGrandTotal(Convert.ToDecimal(num22), int.Parse(str22));
                                ...
                                if ((num25 >= 1.0) && (num24 >= 1.0))
                                {
                                    ...
                                    int num28 = CallBLL.cz_odds_vrssc_bll.UpdateGrandTotalCurrentOdds(num26.ToString(), (num23 - (num24 * num25)).ToString(), str22.ToString());
                                ...
                                {
                                    fgsWTTable = base.GetFgsWTTable(0x13);
                                }
                                CallBLL.cz_autosale_vrssc_bll.DLAutoSale(_kc.get_order_num(), str7, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str11, str10, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, _rate, fgsWTTable);
                                if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                {
                                    fgsWTTable = base.GetFgsWTTable(0x13);
                                }
                                CallBLL.cz_autosale_vrssc_bll.ZDAutoSale(_kc.get_order_num(), str7, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str11, str10, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, _rate, fgsWTTable);
                                if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                {
                                    fgsWTTable = base.GetFgsWTTable(0x13);
                                }
                                CallBLL.cz_autosale_vrssc_bll.GDAutoSale(_kc.get_order_num(), str7, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str11, str10, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, _rate, fgsWTTable);
                                if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                {
                                    fgsWTTable = base.GetFgsWTTable(0x13);
                                }
                                CallBLL.cz_autosale_vrssc_bll.FGSAutoSale(_kc.get_order_num(), str7, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str11, str10, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, _rate, fgsWTTable);
                                if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                                {
                                    num29 = 0x13;
                                    base.Un_Bet_Lock(num29.ToString(), getUserModelInfo.get_zjname(), str22);
                                ...
                                {
                                    base.Un_Bet_Lock(0x13.ToString(), _rate.get_fgsname(), str22);
                                }
                                num13++;
                                if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                                {
                                    base.SetUserDrawback_vrssc(dataTable, str25.ToString());
                                }
                            }
                            base.SetUserRate_kc(_rate);
                            if (FileCacheHelper.get_GetKCPutMoneyCache() != "1")
                            {
                                base.SetUserDrawback_vrssc(dataTable);
                            }
        ...
        public void get_oddsinfo(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataSet set2 = CallBLL.cz_play_vrssc_bll.GetPlay(str, str5, str4);
                if (set2 == null)
                {
                    context.Response.End();
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            ...
                            {
                                DataTable table7;
                                if (CacheHelper.GetCache("kc_drawback_FileCacheKey_vrssc" + str15 + context.Session["user_name"].ToString()) != null)
                                {
                                    DataTable cache = CacheHelper.GetCache("kc_drawback_FileCacheKey_vrssc" + str15 + context.Session["user_name"].ToString()) as DataTable;
                                ...
                                {
                                    drawbackByPlayIds = CallBLL.cz_drawback_vrssc_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                }
                                else
                                {
                                    table7 = drawbackByPlayIds.Clone();
                                    table7 = CallBLL.cz_drawback_vrssc_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                    if (table7 != null)
                                    {
                                        drawbackByPlayIds.Merge(table7);
                                    }
                        ...
                        {
                            drawbackByPlayIds = CacheHelper.GetCache("kc_drawback_FileCacheKey_vrssc" + this.Session["user_name"].ToString()) as DataTable;
                        }
                        else
                        {
                            drawbackByPlayIds = CallBLL.cz_drawback_vrssc_bll.GetDrawbackByPlayIds(str, getUserModelInfo.get_u_name());
                        }
                        ...
                        foreach (DataRow row2 in table3.Rows)
                        {
                            ...
                            if (str23 != "-")
                            {
                                base.GetOdds_KC(0x13, row2["odds_id"].ToString(), ref pl);
                            }
        ...
        public void get_openball(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataTable kCOpenBall = base.GetKCOpenBall(0x13);
                if (kCOpenBall != null)
                {
                    ...
                    string str6 = LSKeys.get_VRSSC_Phase_Seconds().ToString() + "秒";
                    Dictionary<string, string> dictionary2 = new Dictionary<string, string>();
                    DataRow[] rowArray = base.GetLotteryList().Select(string.Format(" id={0} ", 0x13));
        ...
        public void get_ranklist(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                string str2 = "_vrssc_jqkj";
                string str3 = "_vrssc_lmcl";
                string str4 = "_vrssc_cql";
                string str5 = "_vrssc_lryl";
                ...
                else
                {
                    ...
                    DataSet topPhase = CallBLL.cz_phase_vrssc_bll.GetTopPhase(5);
                    if (topPhase != null)
                    {
                        ...
                        foreach (DataRow row in table.Rows)
                        {
                            ...
                            str9 = VRSSCPhase.get_cl_zhdx(str8);
                            str9 = base.SetWordColor(str9.Replace("總和", ""));
                            str10 = VRSSCPhase.get_cl_zhds(str8);
                            str10 = base.SetWordColor(str10.Replace("總和", ""));
                            str11 = VRSSCPhase.get_cl_lh(num.ToString(), num5.ToString());
                            str11 = base.SetWordColor(str11);
                            str12 = VRSSCPhase.get_vrssc_str(string.Concat(new object[] { num, ",", num2, ",", num3 }));
                            str13 = VRSSCPhase.get_vrssc_str(string.Concat(new object[] { num2, ",", num3, ",", num4 }));
                            str14 = VRSSCPhase.get_vrssc_str(string.Concat(new object[] { num3, ",", num4, ",", num5 }));
                ...
                {
                    DataTable table2 = CallBLL.cz_phase_vrssc_bll.GetChangLong().Tables[0];
                ...
                if (str.Equals("vrssc_lmp") || str.Equals("vrssc_d1_5"))
                {
                    ...
                    {
                        list5 = CallBLL.cz_phase_vrssc_bll.PaihangList_LMP(str, 0x19);
                    ...
                    else
                    {
                        ...
                        if (str18 != null)
                        {
                            if (!(str18 == "vrssc_d1"))
                            {
                                ...
                                else if (str18 == "vrssc_d3")
                                {
                                    str17 = "3";
                                }
                                else if (str18 == "vrssc_d4")
                                {
                                    str17 = "4";
                                }
                                else if (str18 == "vrssc_d5")
                                {
                                    str17 = "5";
                                }
                            }
                        ...
                        list5 = CallBLL.cz_phase_vrssc_bll.PaihangListDQ(str17, 0x19);
                        list6 = new List<string> {
                ...
                if (!str.Equals("vrssc_lmp") && !str.Equals("vrssc_d1_5"))
                {
                    ...
                    DataSet lRYL = CallBLL.cz_phase_vrssc_bll.GetLRYL(str17);
        ...
        {
            base.checkLogin();
            base.IsLotteryExist(0x13.ToString());
