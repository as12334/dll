namespace User.Web.L_JSCQSC.Handler
{
    ...
    public class Handler : BaseHandler
    {
        ...
        public void do_put_money(HttpContext context, ref string strResult)
        {
            ...
            if (source.Length > FileCacheHelper.get_GetJSCQSCMaxGroup())
            {
                base.DeleteCreditLock(str);
                result.set_success(400);
                result.set_tipinfo(string.Format("您選擇的號碼超過了最大{0}組，請重新選擇號碼!", FileCacheHelper.get_GetJSCQSCMaxGroup()));
                dictionary.Add("JeuValidate", base.get_JeuValidate());
                result.set_data(dictionary);
                strResult = JsonHandle.ObjectToJson(result);
                return;
        ...
        Label_04F7:;
            ...
            DataTable table2 = CallBLL.cz_phase_jscqsc_bll.GetIsClosedByTime(int.Parse(s)).Tables[0];
            ...
            DataTable plDT = CallBLL.cz_odds_jscqsc_bll.GetPlayOddsByID(str4).Tables[0];
            ...
            else
            {
                ...
                else
                {
                    ...
                    foreach (string str22 in strArray3)
                    {
                        ...
                        {
                            if (CacheHelper.GetCache("kc_drawback_FileCacheKey_jscqsc" + str16 + this.Session["user_name"].ToString()) == null)
                            {
                                table6 = CallBLL.cz_drawback_jscqsc_bll.GetDrawback(str16, str).Tables[0];
                            }
                            else
                            {
                                table6 = base.GetUserDrawback_jscqsc(_rate, getUserModelInfo.get_kc_kind(), str16);
                            }
                        }
                        else if (CacheHelper.GetCache("kc_drawback_FileCacheKey_jscqsc" + this.Session["user_name"].ToString()) == null)
                        {
                            table6 = CallBLL.cz_drawback_jscqsc_bll.GetDrawback(str16, str).Tables[0];
                        }
                        else
                        {
                            table6 = base.GetUserDrawback_jscqsc(_rate, getUserModelInfo.get_kc_kind());
                        }
                        ...
                        base.GetOdds_KC(13, str22, ref pl);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            foreach (string str22 in strArray3)
                            {
                                ...
                                DataTable table8 = CallBLL.cz_odds_jscqsc_bll.GetOddsByID(str22).Tables[0];
                                ...
                                if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                                {
                                    dataTable = base.GetUserDrawback_jscqsc(_rate, getUserModelInfo.get_kc_kind(), str25.ToString());
                                }
                                else
                                {
                                    dataTable = base.GetUserDrawback_jscqsc(_rate, getUserModelInfo.get_kc_kind());
                                }
                                if (dataTable == null)
                                {
                                    base.DeleteCreditLock(str);
                                ...
                                base.GetOdds_KC(13, str22, ref str37);
                                ...
                                CallBLL.cz_odds_jscqsc_bll.UpdateGrandTotal(Convert.ToDecimal(num22), int.Parse(str22));
                                ...
                                if ((num25 >= 1.0) && (num24 >= 1.0))
                                {
                                    ...
                                    int num28 = CallBLL.cz_odds_jscqsc_bll.UpdateGrandTotalCurrentOdds(num26.ToString(), (num23 - (num24 * num25)).ToString(), str22.ToString());
                                ...
                                {
                                    fgsWTTable = base.GetFgsWTTable(13);
                                }
                                CallBLL.cz_autosale_jscqsc_bll.DLAutoSale(_kc.get_order_num(), str7, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str11, str10, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, _rate, fgsWTTable);
                                if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                {
                                    fgsWTTable = base.GetFgsWTTable(13);
                                }
                                CallBLL.cz_autosale_jscqsc_bll.ZDAutoSale(_kc.get_order_num(), str7, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str11, str10, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, _rate, fgsWTTable);
                                if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                {
                                    fgsWTTable = base.GetFgsWTTable(13);
                                }
                                CallBLL.cz_autosale_jscqsc_bll.GDAutoSale(_kc.get_order_num(), str7, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str11, str10, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, _rate, fgsWTTable);
                                if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                {
                                    fgsWTTable = base.GetFgsWTTable(13);
                                }
                                CallBLL.cz_autosale_jscqsc_bll.FGSAutoSale(_kc.get_order_num(), str7, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str11, str10, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, _rate, fgsWTTable);
                                if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                                {
                                    num29 = 13;
                                    base.Un_Bet_Lock(num29.ToString(), getUserModelInfo.get_zjname(), str22);
                                ...
                                {
                                    base.Un_Bet_Lock(13.ToString(), _rate.get_fgsname(), str22);
                                }
                                num13++;
                                if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                                {
                                    base.SetUserDrawback_jscqsc(dataTable, str25.ToString());
                                }
                            }
                            base.SetUserRate_kc(_rate);
                            if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                            {
                                base.SetUserDrawback_jscqsc(dataTable);
                            }
        ...
        public void get_oddsinfo(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataSet set2 = CallBLL.cz_play_jscqsc_bll.GetPlay(str, str5, str4);
                if (set2 == null)
                {
                    context.Response.End();
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            ...
                            {
                                DataTable table7;
                                if (CacheHelper.GetCache("kc_drawback_FileCacheKey_jscqsc" + str15 + context.Session["user_name"].ToString()) != null)
                                {
                                    DataTable cache = CacheHelper.GetCache("kc_drawback_FileCacheKey_jscqsc" + str15 + context.Session["user_name"].ToString()) as DataTable;
                                ...
                                {
                                    drawbackByPlayIds = CallBLL.cz_drawback_jscqsc_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                }
                                else
                                {
                                    table7 = drawbackByPlayIds.Clone();
                                    table7 = CallBLL.cz_drawback_jscqsc_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                    if (table7 != null)
                                    {
                                        drawbackByPlayIds.Merge(table7);
                                    }
                        ...
                        {
                            drawbackByPlayIds = CacheHelper.GetCache("kc_drawback_FileCacheKey_jscqsc" + this.Session["user_name"].ToString()) as DataTable;
                        }
                        else
                        {
                            drawbackByPlayIds = CallBLL.cz_drawback_jscqsc_bll.GetDrawbackByPlayIds(str, getUserModelInfo.get_u_name());
                        }
                        ...
                        foreach (DataRow row2 in table3.Rows)
                        {
                            ...
                            if (str23 != "-")
                            {
                                base.GetOdds_KC(13, row2["odds_id"].ToString(), ref pl);
                            }
        ...
        public void get_openball(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataTable kCOpenBall = base.GetKCOpenBall(13);
                if (kCOpenBall != null)
                {
                    ...
                    string dateDiff = LSKeys.get_JSCQSC_Phase_Interval().ToString() + "分鐘";
                    if (!(string.IsNullOrEmpty(str4) || string.IsNullOrEmpty(str5)))
                    {
                        dateDiff = Utils.GetDateDiff(str4, str5);
                    }
                    Dictionary<string, string> dictionary2 = new Dictionary<string, string>();
                    DataRow[] rowArray = base.GetLotteryList().Select(string.Format(" id={0} ", 13));
        ...
        public void get_ranklist(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                string str2 = "_jscqsc_jqkj";
                string str3 = "_jscqsc_lmcl";
                string str4 = "_jscqsc_cql";
                string str5 = "_jscqsc_lryl";
                ...
                else
                {
                    ...
                    DataSet topPhase = CallBLL.cz_phase_jscqsc_bll.GetTopPhase(5);
                    if (topPhase != null)
                    {
                        ...
                        foreach (DataRow row in table.Rows)
                        {
                            ...
                            str9 = JSCQSCPhase.get_cl_zhdx(str8);
                            str9 = base.SetWordColor(str9.Replace("總和", ""));
                            str10 = JSCQSCPhase.get_cl_zhds(str8);
                            str10 = base.SetWordColor(str10.Replace("總和", ""));
                            str11 = JSCQSCPhase.get_cl_lh(num.ToString(), num5.ToString());
                            str11 = base.SetWordColor(str11);
                            str12 = JSCQSCPhase.get_jscqsc_str(string.Concat(new object[] { num, ",", num2, ",", num3 }));
                            str13 = JSCQSCPhase.get_jscqsc_str(string.Concat(new object[] { num2, ",", num3, ",", num4 }));
                            str14 = JSCQSCPhase.get_jscqsc_str(string.Concat(new object[] { num3, ",", num4, ",", num5 }));
                ...
                {
                    DataTable table2 = CallBLL.cz_phase_jscqsc_bll.GetChangLong().Tables[0];
                ...
                if (str.Equals("jscqsc_lmp") || str.Equals("jscqsc_d1_5"))
                {
                    ...
                    {
                        list5 = CallBLL.cz_phase_jscqsc_bll.PaihangList_LMP(str, 0x19);
                    ...
                    else
                    {
                        ...
                        if (str18 != null)
                        {
                            if (!(str18 == "jscqsc_d1"))
                            {
                                ...
                                else if (str18 == "jscqsc_d3")
                                {
                                    str17 = "3";
                                }
                                else if (str18 == "jscqsc_d4")
                                {
                                    str17 = "4";
                                }
                                else if (str18 == "jscqsc_d5")
                                {
                                    str17 = "5";
                                }
                            }
                        ...
                        list5 = CallBLL.cz_phase_jscqsc_bll.PaihangListDQ(str17, 0x19);
                        list6 = new List<string> {
                ...
                if (!str.Equals("jscqsc_lmp") && !str.Equals("jscqsc_d1_5"))
                {
                    ...
                    DataSet lRYL = CallBLL.cz_phase_jscqsc_bll.GetLRYL(str17);
        ...
        {
            base.checkLogin();
            base.IsLotteryExist(13.ToString());
