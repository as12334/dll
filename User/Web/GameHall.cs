    ...
    public class GameHall : MemberPageBase
    {
        ...
        protected void SetData(string lid)
        {
            ...
            else
            {
                ...
                if ((currentPhase != null) && (currentPhase.Rows.Count > 0))
                {
                    string str3 = currentPhase.Rows[0]["isopen"].ToString();
                    string str4 = currentPhase.Rows[0]["openning"].ToString();
                    string str5 = currentPhase.Rows[0]["opendate"].ToString();
                    string str6 = currentPhase.Rows[0]["endtime"].ToString();
                    DateTime time2 = Convert.ToDateTime(this.DT.Select(string.Format(" id={0} ", lid))[0]["begintime"].ToString());
                    if (str3.Equals("0"))
                    {
                        this.txt_state = "0";
                        DateTime time3 = DateTime.Now;
                        string introduced15 = time3.ToString("yyyy-MM-dd");
                        if (introduced15 == time3.AddHours(7.0).ToString("yyyy-MM-dd"))
                        {
                    ...
                    else
                    {
                        ...
                        this.txt_endtime = Convert.ToDateTime(str6).ToString("HH:mm:ss");
                    }
                }
            }
        }
