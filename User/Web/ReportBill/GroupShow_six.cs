            ...
            for (int i = 0; i < strArray.Length; i++)
            {
                ...
                else
                {
                    ...
                    if (strArray3.Length > 1)
                    {
                        ...
                        str5 = string.Format(str13 + "<span  class='blue'>{0}</span>@<b class='orange'>{1}</b><br /><span  class='blue'>{2}</span>@<b class='orange'>{3}</b>", new object[] { str2, str5.Split(new char[] { ',' })[0], str3, str5.Split(new char[] { ',' })[1] });
                    }
                    else
                    {
                        str5 = string.Format(str13 + "<span  class='blue'>{0}</span>@<b class='orange'>{1}</b>", str2, str5.Split(new char[] { ',' })[0]);
                    }
                    str11 = string.Format("{0:F1}", double.Parse(amount));
                    str12 = string.Format("{0:F1}", double.Parse(s));
                    num += double.Parse(str12);
                    ...
                    if (strArray3.Length > 1)
                    {
                        string str14 = string.Format("{0:F1}", double.Parse(str7));
                        num2 += double.Parse(str14);
                        str = str + string.Format("<td align='right'>{0}&nbsp;</td>", str14);
                    }
                }
                str = str + "</tr>";
            }
            ...
            for (int i = 0; i < strArray3.Length; i++)
            {
                ...
                else
                {
                    ...
                    if (strArray5.Length > 1)
                    {
                        str28 = (num5.Equals(1) && (double.Parse(s) > 0.0)) ? ("<span>▶ </span>" + str19) : str19;
                        str29 = (num5.Equals(2) && (double.Parse(s) > 0.0)) ? ("<span>▶ </span>" + str20) : str20;
                        str22 = string.Format(str32 + "<span  class='blue'>{0}</span>@<b class='orange'>{1}</b><br /><span  class='blue'>{2}</span>@<b class='orange'>{3}</b>", new object[] { str28, str22.Split(new char[] { ',' })[0], str29, str22.Split(new char[] { ',' })[1] });
                    }
                    else
                    {
                        str22 = string.Format(str32 + "<span  class='blue'>{0}</span>@<b class='orange'>{1}</b>", str19, str22.Split(new char[] { ',' })[0]);
                    }
