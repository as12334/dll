namespace User.Web.L_XYNC.Handler
{
    ...
    public class Handler : BaseHandler
    {
        ...
        Label_0526:;
            ...
            DataTable table2 = CallBLL.cz_phase_xync_bll.GetIsClosedByTime(int.Parse(str7)).Tables[0];
            ...
            string[] strArray4 = s.Split(new char[] { ',' });
            string[] strArray5 = str6.Split(new char[] { ',' });
            DataTable plDT = CallBLL.cz_odds_xync_bll.GetPlayOddsByID(item).Tables[0];
            ...
            List<string> list = "329,330,331,1181,1202,1203".Split(new char[] { ',' }).ToList<string>();
            double num15 = 0.0;
            string str28 = "";
            ...
            foreach (string str29 in strArray3)
            {
                ...
                {
                    if (CacheHelper.GetCache("kc_drawback_FileCacheKey_xync" + str23 + this.Session["user_name"].ToString()) == null)
                    {
                        table7 = CallBLL.cz_drawback_xync_bll.GetDrawback(str23, str).Tables[0];
                    }
                    else
                    {
                        table7 = base.GetUserDrawback_xync(rate, getUserModelInfo.get_kc_kind(), str23);
                    }
                }
                ...
                {
                    table7 = base.GetUserDrawback_xync(rate, getUserModelInfo.get_kc_kind());
                }
                ...
                base.GetOdds_KC(3, str29, ref pl);
                ...
                else if (!(double.Parse(s) == double.Parse(num15.ToString())))
                {
                    list2.Add(num16.ToString());
                    list3.Add(num15.ToString());
                }
            ...
            if (!list.Contains(item))
            {
                ...
                foreach (string str29 in strArray3)
                {
                    ...
                    table9 = CallBLL.cz_odds_xync_bll.GetOddsByID(str29).Tables[0];
                    int num41 = int.Parse(table9.Rows[0]["play_id"].ToString());
                    str45 = table9.Rows[0]["play_name"].ToString();
                    str46 = table9.Rows[0]["put_amount"].ToString();
                    str47 = table9.Rows[0]["ratio"].ToString();
                    if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                    {
                        dataTable = base.GetUserDrawback_xync(rate, getUserModelInfo.get_kc_kind(), num41.ToString());
                    }
                    else
                    {
                    ...
                    {
                        str54 = row["u_type"].ToString().Trim();
                        if (str54 != null)
                        {
                            if (!(str54 == "zj"))
                            {
                    ...
                    str49 = num44.ToString();
                    str50 = str49.ToString();
                    base.GetOdds_KC(3, str29, ref str50);
                    playDrawbackValue = base.GetPlayDrawbackValue(str18, str47);
                    if ((playDrawbackValue != 0.0) && (double.Parse(str49) > playDrawbackValue))
                    {
                        base.DeleteCreditLock(str);
                        if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                        {
                    ...
                    _kc.set_play_name(table9.Rows[0]["play_name"].ToString());
                    _kc.set_bet_val(table9.Rows[0]["put_amount"].ToString());
                    _kc.set_odds(str50);
                    ...
                    CallBLL.cz_odds_xync_bll.UpdateGrandTotal(Convert.ToDecimal(num34), int.Parse(str29));
                    ...
                    if ((num37 >= 1.0) && (num36 >= 1.0))
                    {
                        ...
                        num40 = CallBLL.cz_odds_xync_bll.UpdateGrandTotalCurrentOdds(num38.ToString(), num39.ToString(), str29);
                        _log = new cz_system_log();
                        _log.set_user_name("系統");
                        _log.set_children_name("");
                        _log.set_category(table9.Rows[0]["category"].ToString());
                        _log.set_play_name(str45);
                        _log.set_put_amount(str46);
                        num42 = 3;
                        _log.set_l_name(base.GetGameNameByID(num42.ToString()));
                        _log.set_l_phase(str12);
                        _log.set_action("降賠率");
                        _log.set_odds_id(int.Parse(str29));
                        str53 = table9.Rows[0]["current_odds"].ToString();
                        _log.set_old_val(str53);
                        num44 = double.Parse(str53) - num38;
                        ...
                        _odds.set_play_name(str45);
                        _odds.set_put_amount(str46);
                        _odds.set_odds(num38.ToString());
                        _odds.set_lottery_type(3);
                        _odds.set_phase(str12);
                        _odds.set_old_odds(str53);
                        num44 = double.Parse(str53) - num38;
                    ...
                    CallBLL.cz_autosale_xync_bll.DLAutoSale(_kc.get_order_num(), str10, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str15, table9.Rows[0]["play_id"].ToString(), str29.Trim(), str17, str18, str19, str20, str21, str22, str13, str12, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                    {
                        fgsWTTable = base.GetFgsWTTable(3);
                    }
                    CallBLL.cz_autosale_xync_bll.ZDAutoSale(_kc.get_order_num(), str10, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str15, table9.Rows[0]["play_id"].ToString(), str29.Trim(), str17, str18, str19, str20, str21, str22, str13, str12, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                    {
                        fgsWTTable = base.GetFgsWTTable(3);
                    }
                    CallBLL.cz_autosale_xync_bll.GDAutoSale(_kc.get_order_num(), str10, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str15, table9.Rows[0]["play_id"].ToString(), str29.Trim(), str17, str18, str19, str20, str21, str22, str13, str12, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                    {
                        fgsWTTable = base.GetFgsWTTable(3);
                    }
                    CallBLL.cz_autosale_xync_bll.FGSAutoSale(_kc.get_order_num(), str10, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str15, table9.Rows[0]["play_id"].ToString(), str29.Trim(), str17, str18, str19, str20, str21, str22, str13, str12, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                    if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                    {
                        num42 = 3;
                        base.Un_Bet_Lock(num42.ToString(), getUserModelInfo.get_zjname(), str29);
                    ...
                    if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                    {
                        base.SetUserDrawback_xync(dataTable, num41.ToString());
                    }
                }
            ...
            if ((item != "330") && !base.checkVal(num, ref str35))
            {
                base.DeleteCreditLock(str);
            ...
            if (!(item == "330"))
            {
                if ((item == "329") || (item == "331"))
                {
                    str32 = base.getfz(str35, 2);
                    str33 = get_ball_pl(str23, double.Parse(s), str35);
                }
                else if (item == "1181")
                {
            ...
            string[] strArray6 = str35.Split(new char[] { ',' });
            string str36 = "";
            string a = "";
            string b = "";
            string str39 = base.getlongnum(str35.Split(new char[] { '|' })[0]);
            string str40 = base.getlongnum(str35.Split(new char[] { '|' })[1]);
            int num21 = 0;
        Label_1580:;
            if (num21 < str39.Split(new char[] { ',' }).Length)
            {
                a = a + str39.Split(new char[] { ',' })[num21] + ",";
                num21++;
                goto Label_1580;
            }
            num21 = 0;
        Label_15D8:;
            ...
            {
                b = b + str40.Split(new char[] { ',' })[num21] + ",";
                num21++;
                goto Label_15D8;
            }
            a = a.Substring(0, a.Length - 1);
            b = b.Substring(0, b.Length - 1);
            if (!(base.checkVal(num, ref a) && base.checkVal(num, ref b)))
            {
                base.DeleteCreditLock(str);
        ...
        Label_17AB:;
            ...
            else if ((length * double.Parse(str6)) == double.Parse(str9))
            {
                double num22 = num12 - double.Parse(str6);
                string str41 = "";
                string str42 = "";
                string[] strArray7 = str32.Split(new char[] { '~' });
                int num23 = 0;
                foreach (string str43 in strArray7)
                {
                    if (num23 == 0)
                    {
                        if (item.Equals("330"))
                        ...
                        {
                            str41 = str41 + "'" + px(str43) + "'";
                            str42 = str42 + px(str43);
                        }
                    }
                    else if (item.Equals("330"))
                    {
                        str41 = str41 + ",'" + str43 + "'";
                        str42 = str42 + "|" + str43;
                    }
                ...
                DataTable table8 = CallBLL.cz_bet_kc_bll.DQLMValid(int.Parse(item), getUserModelInfo.get_u_name(), str42, num22, "xync", str13);
                if (table8 != null)
                {
                    base.DeleteCreditLock(str);
                ...
                {
                    double num24 = double.Parse(str6) * length;
                    if (double.Parse(str6) > num10)
                    {
                        base.DeleteCreditLock(str);
                    ...
                    else
                    {
                        ...
                        table9 = CallBLL.cz_odds_xync_bll.GetOddsByID(item).Tables[0];
                        string str44 = table9.Rows[0]["play_id"].ToString();
                        str45 = table9.Rows[0]["play_name"].ToString();
                        str46 = table9.Rows[0]["put_amount"].ToString();
                        str47 = table9.Rows[0]["ratio"].ToString();
                        if (!str44.Equals("73"))
                        {
                            string str48 = base.GetLmGroup()[str44 + "_" + 3];
                            int num25 = int.Parse(str48.Split(new char[] { ',' })[1]);
                        ...
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            dataTable = base.GetUserDrawback_xync(rate, getUserModelInfo.get_kc_kind(), str44.ToString());
                        }
                        else
                        {
                            dataTable = base.GetUserDrawback_xync(rate, getUserModelInfo.get_kc_kind());
                        ...
                        {
                            rowArray2 = dataTable.Select(string.Format(" play_id={0} ", str44));
                            foreach (DataRow row in rowArray2)
                            {
                                str54 = row["u_type"].ToString().Trim();
                                if (str54 != null)
                            ...
                            str49 = num44.ToString();
                            str50 = str49.ToString();
                            base.GetOdds_KC(3, item, ref str50);
                            playDrawbackValue = base.GetPlayDrawbackValue(str18, str47);
                            if ((playDrawbackValue != 0.0) && (double.Parse(str49) > playDrawbackValue))
                            {
                                base.DeleteCreditLock(str);
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    num29 = double.Parse(strArray8[0].ToString());
                                    if (strArray8.Length > 1)
                                    {
                                        num30 = double.Parse(strArray8[1].ToString());
                                    }
                                    double num31 = 0.0;
                                    double num32 = 0.0;
                                    string[] strArray9 = str49.Split(new char[] { ',' });
                                    num31 = double.Parse(strArray9[0].ToString());
                                    if (strArray9.Length > 1)
                                    {
                                        num32 = double.Parse(strArray9[1].ToString());
                                    }
                                    string[] strArray10 = str32.Split(new char[] { '~' });
                                    string str51 = "";
                                    cz_splitgroup_xync _xync = new cz_splitgroup_xync();
                                    _xync.set_odds_id(new int?(int.Parse(item)));
                                    _xync.set_item_money(new decimal?((decimal) num28));
                                    _xync.set_odds1(new decimal?(Convert.ToDecimal(num29.ToString())));
                                    _xync.set_odds2(new decimal?(Convert.ToDecimal(num30.ToString())));
                                    _xync.set_bet_id(new int?(num27));
                                    _xync.set_odds1_zj(new decimal?(Convert.ToDecimal(num31.ToString())));
                                    _xync.set_odds2_zj(new decimal?(Convert.ToDecimal(num32.ToString())));
                                    if (item == "330")
                                    {
                                        foreach (string str52 in strArray10)
                                        {
                                            str51 = str52;
                                            _xync.set_item(str51);
                                            if (CallBLL.cz_splitgroup_xync_bll.AddSplitGroup(_xync) == 0)
                                            {
                                                base.DeleteCreditLock(str);
                                                if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                                                {
                                    ...
                                    CallBLL.cz_odds_xync_bll.UpdateGrandTotal(Convert.ToDecimal(num34), int.Parse(item));
                                    num35 = double.Parse(table9.Rows[0]["grand_total"].ToString()) + num34;
                                    num36 = double.Parse(table9.Rows[0]["downbase"].ToString());
                                    num37 = Math.Floor((double) (num35 / num36));
                                    if ((num37 >= 1.0) && (num36 >= 1.0))
                                    {
                                        num38 = double.Parse(table9.Rows[0]["down_odds_rate"].ToString()) * num37;
                                        num40 = CallBLL.cz_odds_xync_bll.UpdateGrandTotalCurrentOdds(num38.ToString(), (num35 - (num36 * num37)).ToString(), item);
                                        _log = new cz_system_log();
                                        _log.set_user_name("系統");
                                        _log.set_children_name("");
                                        _log.set_category(table9.Rows[0]["category"].ToString());
                                        ...
                                        _odds.set_phase(str12);
                                        _odds.set_old_odds(str53);
                                        _odds.set_new_odds((double.Parse(str53) - num38).ToString());
                                        CallBLL.cz_jp_odds_bll.Add(_odds);
                                    }
                                    fgsWTTable = null;
                                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                    ...
                                    CallBLL.cz_autosale_xync_bll.DLAutoSaleLM(_kc.get_order_num(), str10, int.Parse(table9.Rows[0]["play_id"].ToString()), int.Parse(item.Trim()), str15, double.Parse(_kc.get_odds()), num, _kc.get_lottery_name(), int.Parse(str13), str12, str17, str18, str19, str20, str21, str22, _kc.get_ip(), getUserModelInfo, rate, fgsWTTable);
                                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                    {
                                        fgsWTTable = base.GetFgsWTTable(3);
                                    }
                                    CallBLL.cz_autosale_xync_bll.ZDAutoSaleLM(_kc.get_order_num(), str10, int.Parse(table9.Rows[0]["play_id"].ToString()), int.Parse(item.Trim()), str15, double.Parse(_kc.get_odds()), num, _kc.get_lottery_name(), int.Parse(str13), str12, str17, str18, str19, str20, str21, str22, _kc.get_ip(), getUserModelInfo, rate, fgsWTTable);
                                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                    {
                                        fgsWTTable = base.GetFgsWTTable(3);
                                    }
                                    CallBLL.cz_autosale_xync_bll.GDAutoSaleLM(_kc.get_order_num(), str10, int.Parse(table9.Rows[0]["play_id"].ToString()), int.Parse(item.Trim()), str15, double.Parse(_kc.get_odds()), num, _kc.get_lottery_name(), int.Parse(str13), str12, str17, str18, str19, str20, str21, str22, _kc.get_ip(), getUserModelInfo, rate, fgsWTTable);
                                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                    {
                                        fgsWTTable = base.GetFgsWTTable(3);
                                    }
                                    CallBLL.cz_autosale_xync_bll.FGSAutoSaleLM(_kc.get_order_num(), str10, int.Parse(table9.Rows[0]["play_id"].ToString()), int.Parse(item.Trim()), str15, double.Parse(_kc.get_odds()), num, _kc.get_lottery_name(), int.Parse(str13), str12, str17, str18, str19, str20, str21, str22, _kc.get_ip(), getUserModelInfo, rate, fgsWTTable);
                                    if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                                    {
                                        num42 = 3;
                                        base.Un_Bet_Lock(num42.ToString(), getUserModelInfo.get_zjname(), item);
                                    ...
                                    {
                                        base.Un_Bet_Lock(3.ToString(), rate.get_fgsname(), item);
                                    }
                                    base.SetUserRate_kc(rate);
                                    if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                                    {
                                        base.SetUserDrawback_xync(dataTable, str44);
                                    }
                                    else
                                    {
                                        base.SetUserDrawback_xync(dataTable);
        ...
        public static string get_ball_pl(string playid, double pl, string nos)
        {
            ...
            DataTable table = CallBLL.cz_wt_xync_bll.GetWtByPlayID(int.Parse(playid), nos).Tables[0];
        ...
        public void get_oddsinfo(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataSet set2 = CallBLL.cz_play_xync_bll.GetPlay(str, str5, str4, str2);
                if (set2 == null)
                {
                    context.Response.End();
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            ...
                            {
                                DataTable table7;
                                if (CacheHelper.GetCache("kc_drawback_FileCacheKey_xync" + str15 + context.Session["user_name"].ToString()) != null)
                                {
                                    DataTable cache = CacheHelper.GetCache("kc_drawback_FileCacheKey_xync" + str15 + context.Session["user_name"].ToString()) as DataTable;
                                ...
                                {
                                    drawbackByPlayIds = CallBLL.cz_drawback_xync_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                }
                                else
                                {
                                    table7 = drawbackByPlayIds.Clone();
                                    table7 = CallBLL.cz_drawback_xync_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                    if (table7 != null)
                                    {
                                        drawbackByPlayIds.Merge(table7);
                                    }
                        ...
                        {
                            drawbackByPlayIds = CacheHelper.GetCache("kc_drawback_FileCacheKey_xync" + this.Session["user_name"].ToString()) as DataTable;
                        }
                        else
                        {
                            drawbackByPlayIds = CallBLL.cz_drawback_xync_bll.GetDrawbackByPlayIds(str, getUserModelInfo.get_u_name());
                        }
                        ...
                        foreach (DataRow row2 in table3.Rows)
                        {
                            ...
                            string str21 = "";
                            string str22 = "";
                            if ((((str2 == "xync_lm") && (table4 != null)) && (table4.Rows.Count > 0)) && !row2["play_id"].ToString().Trim().Equals("73"))
                            {
                            ...
                            if (str23 != "-")
                            {
                                base.GetOdds_KC(3, row2["odds_id"].ToString(), ref pl);
                            }
        ...
        public void get_openball(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataTable kCOpenBall = base.GetKCOpenBall(3);
                if (kCOpenBall != null)
                {
                    ...
                    string str5 = kCOpenBall.Rows[0]["open_date"].ToString().Trim();
                    string str6 = kCOpenBall.Rows[0]["play_open_date"].ToString().Trim();
                    string dateDiff = LSKeys.get_XYNC_Phase_Interval().ToString() + "分鐘";
                    if (!(string.IsNullOrEmpty(str5) || string.IsNullOrEmpty(str6)))
                    {
                        dateDiff = Utils.GetDateDiff(str5, str6);
                    }
                    Dictionary<string, string> dictionary2 = new Dictionary<string, string>();
                    DataRow[] rowArray = base.GetLotteryList().Select(string.Format(" id={0} ", 3));
                    ...
                    dictionary2.Add("sold", str3);
                    dictionary2.Add("surplus", str4);
                    string str8 = kCOpenBall.Rows[0]["nns"].ToString().Trim();
                    ArrayList list2 = new ArrayList();
                    list2.Add(str3);
                    list2.Add(str4);
                    ArrayList list = list2;
                    string[] strArray = str8.Split(new char[] { ',' }).ToArray<string>();
        ...
        public void get_ranklist(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                string str2 = "_xync_jqkj";
                string str3 = "_xync_lmcl";
                string str4 = "_xync_cql";
                string str5 = "_xync_lryl";
                ...
                else
                {
                    ...
                    DataSet topPhase = CallBLL.cz_phase_xync_bll.GetTopPhase(5);
                    if (topPhase != null)
                    {
                        string str6 = "";
                        string str7 = "";
                        ...
                        foreach (DataRow row in table.Rows)
                        {
                            ...
                            {
                                string str12 = "n" + num3;
                                collection.Add(row[str12].ToString());
                                num += Convert.ToInt32(row[str12]);
                                num3++;
                            }
                            if (num == 0x54)
                            {
                            ...
                            dictionary2.Add("total", new List<string> { num.ToString(), str8, str9, str10, str11 });
                ...
                if (str.Equals("xync_lmp") || (str == "xync_zhjqys"))
                {
                    ...
                    {
                        list5 = CallBLL.cz_phase_xync_bll.PaihangListLMP(str, 0x19);
                        list6 = new List<string> { "家禽野獸", "總和大小", "總和單雙", "總和尾大小" };
                ...
                if ((((str.Equals("xync_d1") || str.Equals("xync_d2")) || (str.Equals("xync_d3") || str.Equals("xync_d4"))) || ((str.Equals("xync_d5") || str.Equals("xync_d6")) || str.Equals("xync_d7"))) || str.Equals("xync_d8"))
                {
                    str15 = "1";
                    switch (str)
                    {
                    ...
                    {
                        list5 = CallBLL.cz_phase_xync_bll.PaihangListDQ(str15, 0x19);
                        list6 = new List<string> {
                            string.Format("第{0}球", str15),
                            "單雙",
                            "大小",
                            "合數單雙",
                            "尾大小",
                ...
                if ((((str.Equals("xync_d1") || str.Equals("xync_d2")) || (str.Equals("xync_d3") || str.Equals("xync_d4"))) || ((str.Equals("xync_d5") || str.Equals("xync_d6")) || str.Equals("xync_d7"))) || str.Equals("xync_d8"))
                {
                    ...
                    {
                        DataSet lRYL = CallBLL.cz_phase_xync_bll.GetLRYL(str15);
                        ...
                        if (lRYL != null)
                        {
                            ...
                            {
                                ArrayList list8 = new ArrayList();
                                for (num3 = 0; num3 < table3.Columns.Count; num3++)
                                {
                                    list8.Add(table3.Columns[num3].ColumnName);
                                }
        ...
        {
            base.checkLogin();
            base.IsLotteryExist(3.ToString());
