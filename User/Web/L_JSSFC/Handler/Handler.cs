namespace User.Web.L_JSSFC.Handler
{
    ...
    public class Handler : BaseHandler
    {
        ...
        public void do_put_money(HttpContext context, ref string strResult)
        {
            ...
            if (source.Length > FileCacheHelper.get_GetJSSFCMaxGroup())
            {
                base.DeleteCreditLock(str);
                result.set_success(400);
                result.set_tipinfo(string.Format("您選擇的號碼超過了最大{0}組，請重新選擇號碼!", FileCacheHelper.get_GetJSSFCMaxGroup()));
                dictionary.Add("JeuValidate", base.get_JeuValidate());
                result.set_data(dictionary);
                strResult = JsonHandle.ObjectToJson(result);
                return;
        ...
        Label_0535:;
            ...
            DataTable table2 = CallBLL.cz_phase_jssfc_bll.GetIsClosedByTime(int.Parse(s)).Tables[0];
            ...
            DataTable plDT = CallBLL.cz_odds_jssfc_bll.GetPlayOddsByID(item).Tables[0];
            ...
            foreach (string str29 in strArray3)
            {
                ...
                {
                    if (CacheHelper.GetCache("kc_drawback_FileCacheKey_jssfc" + str23 + this.Session["user_name"].ToString()) == null)
                    {
                        table7 = CallBLL.cz_drawback_jssfc_bll.GetDrawback(str23, str).Tables[0];
                    }
                    else
                    {
                        table7 = base.GetUserDrawback_jssfc(rate, getUserModelInfo.get_kc_kind(), str23);
                    }
                }
                else if (CacheHelper.GetCache("kc_drawback_FileCacheKey_jssfc" + this.Session["user_name"].ToString()) == null)
                {
                    table7 = CallBLL.cz_drawback_jssfc_bll.GetDrawback(str23, str).Tables[0];
                }
                else
                {
                    table7 = base.GetUserDrawback_jssfc(rate, getUserModelInfo.get_kc_kind());
                }
                ...
                base.GetOdds_KC(14, str29, ref pl);
            ...
            if (!list.Contains(item))
            {
                ...
                foreach (string str29 in strArray3)
                {
                    ...
                    table9 = CallBLL.cz_odds_jssfc_bll.GetOddsByID(str29).Tables[0];
                    ...
                    if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                    {
                        dataTable = base.GetUserDrawback_jssfc(rate, getUserModelInfo.get_kc_kind(), num41.ToString());
                    }
                    else
                    {
                        dataTable = base.GetUserDrawback_jssfc(rate, getUserModelInfo.get_kc_kind());
                    }
                    if (dataTable == null)
                    {
                        base.DeleteCreditLock(str);
                    ...
                    base.GetOdds_KC(14, str29, ref str52);
                    ...
                    CallBLL.cz_odds_jssfc_bll.UpdateGrandTotal(Convert.ToDecimal(num34), int.Parse(str29));
                    ...
                    if ((num37 >= 1.0) && (num36 >= 1.0))
                    {
                        ...
                        num40 = CallBLL.cz_odds_jssfc_bll.UpdateGrandTotalCurrentOdds(num38.ToString(), num39.ToString(), str29);
                    ...
                    {
                        fgsWTTable = base.GetFgsWTTable(14);
                    }
                    CallBLL.cz_autosale_jssfc_bll.DLAutoSale(_kc.get_order_num(), str10, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str15, table9.Rows[0]["play_id"].ToString(), str29.Trim(), str17, str18, str19, str20, str21, str22, str13, str12, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, 0, fgsWTTable);
                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                    {
                        fgsWTTable = base.GetFgsWTTable(14);
                    }
                    CallBLL.cz_autosale_jssfc_bll.ZDAutoSale(_kc.get_order_num(), str10, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str15, table9.Rows[0]["play_id"].ToString(), str29.Trim(), str17, str18, str19, str20, str21, str22, str13, str12, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, 0, fgsWTTable);
                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                    {
                        fgsWTTable = base.GetFgsWTTable(14);
                    }
                    CallBLL.cz_autosale_jssfc_bll.GDAutoSale(_kc.get_order_num(), str10, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str15, table9.Rows[0]["play_id"].ToString(), str29.Trim(), str17, str18, str19, str20, str21, str22, str13, str12, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, 0, fgsWTTable);
                    if (getUserModelInfo.get_kc_op_odds().Equals(1))
                    {
                        fgsWTTable = base.GetFgsWTTable(14);
                    }
                    CallBLL.cz_autosale_jssfc_bll.FGSAutoSale(_kc.get_order_num(), str10, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str15, table9.Rows[0]["play_id"].ToString(), str29.Trim(), str17, str18, str19, str20, str21, str22, str13, str12, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, 0, fgsWTTable);
                    if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                    {
                        num42 = 14;
                        base.Un_Bet_Lock(num42.ToString(), getUserModelInfo.get_zjname(), str29);
                    ...
                    if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                    {
                        base.SetUserDrawback_jssfc(dataTable, num41.ToString());
                    }
                }
                base.SetUserRate_kc(rate);
                if (FileCacheHelper.get_GetKCPutMoneyCache() != "1")
                {
                    base.SetUserDrawback_jssfc(dataTable);
                }
        ...
        Label_1AF2:;
            ...
            else
            {
                if ((length * double.Parse(str8)) == double.Parse(str9))
                {
                    ...
                    DataTable table8 = CallBLL.cz_bet_kc_bll.DQLMValid(int.Parse(item), getUserModelInfo.get_u_name(), str44, num22, "jssfc", str13);
                    if (table8 != null)
                    {
                        base.DeleteCreditLock(str);
                    ...
                    table9 = CallBLL.cz_odds_jssfc_bll.GetOddsByID(item).Tables[0];
                    ...
                    {
                        string str50 = base.GetLmGroup()[str46 + "_" + 14];
                    ...
                    if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                    {
                        dataTable = base.GetUserDrawback_jssfc(rate, getUserModelInfo.get_kc_kind(), str46.ToString());
                    }
                    else
                    {
                        dataTable = base.GetUserDrawback_jssfc(rate, getUserModelInfo.get_kc_kind());
                    ...
                    str51 = num44.ToString();
                    str52 = str51.ToString();
                    base.GetOdds_KC(14, item, ref str52);
                    playDrawbackValue = base.GetPlayDrawbackValue(str18, str49);
                    if ((playDrawbackValue != 0.0) && (double.Parse(str51) > playDrawbackValue))
                    {
                        base.DeleteCreditLock(str);
                    ...
                    _jssfc.set_odds_id(new int?(int.Parse(item)));
                    _jssfc.set_item_money(new decimal?((decimal) num28));
                    _jssfc.set_odds1(new decimal?(Convert.ToDecimal(num29.ToString())));
                    _jssfc.set_odds2(new decimal?(Convert.ToDecimal(num30.ToString())));
                    _jssfc.set_bet_id(new int?(num27));
                    _jssfc.set_odds1_zj(new decimal?(Convert.ToDecimal(num31.ToString())));
                    _jssfc.set_odds2_zj(new decimal?(Convert.ToDecimal(num32.ToString())));
                    switch (item)
                    {
                        case "330":
                        case "1200":
                            ...
                            {
                                str53 = str54;
                                _jssfc.set_item(str53);
                                if (CallBLL.cz_splitgroup_jssfc_bll.AddSplitGroup(_jssfc) == 0)
                                {
                                    base.DeleteCreditLock(str);
                                    if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                                    {
        ...
        Label_2E31:
            ...
            CallBLL.cz_odds_jssfc_bll.UpdateGrandTotal(Convert.ToDecimal(num34), int.Parse(item.Trim()));
            num35 = double.Parse(table9.Rows[0]["grand_total"].ToString()) + num34;
            num36 = double.Parse(table9.Rows[0]["downbase"].ToString());
            num37 = Math.Floor((double) (num35 / num36));
            if ((num37 >= 1.0) && (num36 >= 1.0))
            {
                num38 = double.Parse(table9.Rows[0]["down_odds_rate"].ToString()) * num37;
                num40 = CallBLL.cz_odds_jssfc_bll.UpdateGrandTotalCurrentOdds(num38.ToString(), (num35 - (num36 * num37)).ToString(), item);
                _log = new cz_system_log();
                _log.set_user_name("系統");
                _log.set_children_name("");
                _log.set_category(table9.Rows[0]["category"].ToString());
            ...
            CallBLL.cz_autosale_jssfc_bll.DLAutoSaleLM(_kc.get_order_num(), str10, int.Parse(table9.Rows[0]["play_id"].ToString()), int.Parse(item.Trim()), double.Parse(_kc.get_odds()), num, _kc.get_lottery_name(), int.Parse(str13), str12, str17, str18, str19, str20, str21, str22, _kc.get_ip(), getUserModelInfo, rate, 1, str15, fgsWTTable);
            if (getUserModelInfo.get_kc_op_odds().Equals(1))
            {
                fgsWTTable = base.GetFgsWTTable(14);
            }
            CallBLL.cz_autosale_jssfc_bll.ZDAutoSaleLM(_kc.get_order_num(), str10, int.Parse(table9.Rows[0]["play_id"].ToString()), int.Parse(item.Trim()), double.Parse(_kc.get_odds()), num, _kc.get_lottery_name(), int.Parse(str13), str12, str17, str18, str19, str20, str21, str22, _kc.get_ip(), getUserModelInfo, rate, 1, str15, fgsWTTable);
            if (getUserModelInfo.get_kc_op_odds().Equals(1))
            {
                fgsWTTable = base.GetFgsWTTable(14);
            }
            CallBLL.cz_autosale_jssfc_bll.GDAutoSaleLM(_kc.get_order_num(), str10, int.Parse(table9.Rows[0]["play_id"].ToString()), int.Parse(item.Trim()), double.Parse(_kc.get_odds()), num, _kc.get_lottery_name(), int.Parse(str13), str12, str17, str18, str19, str20, str21, str22, _kc.get_ip(), getUserModelInfo, rate, 1, str15, fgsWTTable);
            if (getUserModelInfo.get_kc_op_odds().Equals(1))
            {
                fgsWTTable = base.GetFgsWTTable(14);
            }
            CallBLL.cz_autosale_jssfc_bll.FGSAutoSaleLM(_kc.get_order_num(), str10, int.Parse(table9.Rows[0]["play_id"].ToString()), int.Parse(item.Trim()), double.Parse(_kc.get_odds()), num, _kc.get_lottery_name(), int.Parse(str13), str12, str17, str18, str19, str20, str21, str22, _kc.get_ip(), getUserModelInfo, rate, 1, str15, fgsWTTable);
            if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
            {
                num42 = 14;
                base.Un_Bet_Lock(num42.ToString(), getUserModelInfo.get_zjname(), item);
            ...
            {
                base.Un_Bet_Lock(14.ToString(), rate.get_fgsname(), item);
            }
            base.DeleteCreditLock(str);
            result.set_tipinfo(string.Format("下注成功！", new object[0]));
            result.set_success(200);
            ...
            if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
            {
                base.SetUserDrawback_jssfc(dataTable, str46);
            }
            else
            {
                base.SetUserDrawback_jssfc(dataTable);
        ...
        public void get_oddsinfo(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataSet set2 = CallBLL.cz_play_jssfc_bll.GetPlay(str, str5, str4, str2);
                if (set2 == null)
                {
                    context.Response.End();
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            ...
                            {
                                DataTable table7;
                                if (CacheHelper.GetCache("kc_drawback_FileCacheKey_jssfc" + str15 + context.Session["user_name"].ToString()) != null)
                                {
                                    DataTable cache = CacheHelper.GetCache("kc_drawback_FileCacheKey_jssfc" + str15 + context.Session["user_name"].ToString()) as DataTable;
                                ...
                                {
                                    drawbackByPlayIds = CallBLL.cz_drawback_jssfc_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                }
                                else
                                {
                                    table7 = drawbackByPlayIds.Clone();
                                    table7 = CallBLL.cz_drawback_jssfc_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                    if (table7 != null)
                                    {
                                        drawbackByPlayIds.Merge(table7);
                                    }
                        ...
                        {
                            drawbackByPlayIds = CacheHelper.GetCache("kc_drawback_FileCacheKey_jssfc" + this.Session["user_name"]) as DataTable;
                        }
                        else
                        {
                            drawbackByPlayIds = CallBLL.cz_drawback_jssfc_bll.GetDrawbackByPlayIds(str, getUserModelInfo.get_u_name());
                        }
                        ...
                        foreach (DataRow row2 in table3.Rows)
                        {
                            ...
                            string str21 = "";
                            string str22 = "";
                            if ((((str2 == "jssfc_lm") && (table4 != null)) && (table4.Rows.Count > 0)) && (!row2["play_id"].ToString().Trim().Equals("73") && !row2["play_id"].ToString().Trim().Equals("76")))
                            {
                            ...
                            if (str23 != "-")
                            {
                                base.GetOdds_KC(14, row2["odds_id"].ToString(), ref pl);
                            }
        ...
        public void get_openball(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataTable kCOpenBall = base.GetKCOpenBall(14);
                if (kCOpenBall != null)
                {
                    ...
                    string dateDiff = LSKeys.get_JSSFC_Phase_Interval().ToString() + "分鐘";
                    if (!(string.IsNullOrEmpty(str4) || string.IsNullOrEmpty(str5)))
                    {
                        dateDiff = Utils.GetDateDiff(str4, str5);
                    }
                    Dictionary<string, string> dictionary2 = new Dictionary<string, string>();
                    DataRow[] rowArray = base.GetLotteryList().Select(string.Format(" id={0} ", 14));
        ...
        public void get_ranklist(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                string str2 = "_jssfc_jqkj";
                string str3 = "_jssfc_lmcl";
                string str4 = "_jssfc_cql";
                string str5 = "_jssfc_lryl";
                ...
                else
                {
                    ...
                    DataSet topPhase = CallBLL.cz_phase_jssfc_bll.GetTopPhase(5);
                    if (topPhase != null)
                    {
                        ...
                        foreach (DataRow row in table.Rows)
                        {
                            ...
                            str8 = JSSFCPhase.get_zh(collection).ToString();
                            str9 = JSSFCPhase.get_cl_zhdx(str8);
                            str9 = base.SetWordColor(str9.Replace("總和", ""));
                            str10 = JSSFCPhase.get_cl_zhds(str8);
                            str10 = base.SetWordColor(str10.Replace("總和", ""));
                            str11 = JSSFCPhase.get_cl_zhwsdx(str8);
                            str11 = base.SetWordColor(str11.Replace("總和", ""));
                            str12 = JSSFCPhase.get_cl_lh(collection[0].ToString(), collection[num - 1].ToString());
                ...
                {
                    Dictionary<string, string> paiHang = CallBLL.cz_phase_jssfc_bll.GetPaiHang(str16, 0x19);
                ...
                if (Utils.IsNumeric(str16))
                {
                    ...
                    {
                        DataSet lRYL = CallBLL.cz_phase_jssfc_bll.GetLRYL(str16);
        ...
        {
            base.checkLogin();
            base.IsLotteryExist(14.ToString());
