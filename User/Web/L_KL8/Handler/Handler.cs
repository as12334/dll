namespace User.Web.L_KL8.Handler
{
    ...
    public class Handler : BaseHandler
    {
        ...
        public void do_put_money(HttpContext context, ref string strResult)
        {
            ...
            if (source.Length > FileCacheHelper.get_GetKL8MaxGroup())
            {
                base.DeleteCreditLock(str);
                result.set_success(400);
                result.set_tipinfo(string.Format("您選擇的號碼超過了最大{0}組，請重新選擇號碼!", FileCacheHelper.get_GetKL8MaxGroup()));
                dictionary.Add("JeuValidate", base.get_JeuValidate());
                result.set_data(dictionary);
                strResult = JsonHandle.ObjectToJson(result);
                return;
        ...
        Label_052A:;
            ...
            DataTable table2 = CallBLL.cz_phase_kl8_bll.GetIsClosedByTime(int.Parse(s)).Tables[0];
            ...
            DataTable plDT = CallBLL.cz_odds_kl8_bll.GetPlayOddsByID(str6).Tables[0];
            ...
            else
            {
                ...
                else
                {
                    ...
                    foreach (string str22 in strArray3)
                    {
                        ...
                        {
                            if (CacheHelper.GetCache("kc_drawback_FileCacheKey_kl8" + str16 + this.Session["user_name"].ToString()) == null)
                            {
                                table6 = CallBLL.cz_drawback_kl8_bll.GetDrawback(str16, str).Tables[0];
                            }
                            else
                            {
                                table6 = base.GetUserDrawback_kl8(rate, getUserModelInfo.get_kc_kind(), str16);
                            }
                        }
                        else if (CacheHelper.GetCache("kc_drawback_FileCacheKey_kl8" + this.Session["user_name"].ToString()) == null)
                        {
                            table6 = CallBLL.cz_drawback_kl8_bll.GetDrawback(str16, str).Tables[0];
                        }
                        else
                        {
                            table6 = base.GetUserDrawback_kl8(rate, getUserModelInfo.get_kc_kind());
                        }
                        ...
                        base.GetOdds_KC(5, str22, ref pl);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            foreach (string str22 in strArray3)
                            {
                                ...
                                DataTable table8 = CallBLL.cz_odds_kl8_bll.GetOddsByID(str22).Tables[0];
                                ...
                                if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                                {
                                    dataTable = base.GetUserDrawback_kl8(rate, getUserModelInfo.get_kc_kind(), str25.ToString());
                                }
                                else
                                {
                                    dataTable = base.GetUserDrawback_kl8(rate, getUserModelInfo.get_kc_kind());
                                }
                                if (dataTable == null)
                                {
                                    base.DeleteCreditLock(str);
                                ...
                                base.GetOdds_KC(5, str22, ref str37);
                                ...
                                CallBLL.cz_odds_kl8_bll.UpdateGrandTotal(Convert.ToDecimal(num22), int.Parse(str22));
                                ...
                                if ((num25 >= 1.0) && (num24 >= 1.0))
                                {
                                    ...
                                    int num28 = CallBLL.cz_odds_kl8_bll.UpdateGrandTotalCurrentOdds(num26.ToString(), (num23 - (num24 * num25)).ToString(), str22.ToString());
                                ...
                                {
                                    fgsWTTable = base.GetFgsWTTable(5);
                                }
                                CallBLL.cz_autosale_kl8_bll.DLAutoSale(_kc.get_order_num(), str9, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str12, str11, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                                if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                {
                                    fgsWTTable = base.GetFgsWTTable(5);
                                }
                                CallBLL.cz_autosale_kl8_bll.ZDAutoSale(_kc.get_order_num(), str9, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str12, str11, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                                if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                {
                                    fgsWTTable = base.GetFgsWTTable(5);
                                }
                                CallBLL.cz_autosale_kl8_bll.GDAutoSale(_kc.get_order_num(), str9, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str12, str11, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                                if (getUserModelInfo.get_kc_op_odds().Equals(1))
                                {
                                    fgsWTTable = base.GetFgsWTTable(5);
                                }
                                CallBLL.cz_autosale_kl8_bll.FGSAutoSale(_kc.get_order_num(), str9, getUserModelInfo.get_u_nicker(), getUserModelInfo.get_u_name(), str14, table8.Rows[0]["play_id"].ToString(), str22.Trim(), str29, str30, str31, str32, str33, str34, str12, str11, _kc.get_ip(), num, _kc.get_lottery_name(), getUserModelInfo, rate, fgsWTTable);
                                if (FileCacheHelper.get_AddBetLockUType_KC().Equals("zj"))
                                {
                                    num29 = 5;
                                    base.Un_Bet_Lock(num29.ToString(), getUserModelInfo.get_zjname(), str22);
                                ...
                                {
                                    base.Un_Bet_Lock(5.ToString(), rate.get_fgsname(), str22);
                                }
                                num13++;
                                if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                                {
                                    base.SetUserDrawback_kl8(dataTable, str25.ToString());
                                }
                            }
                            base.SetUserRate_kc(rate);
                            if (FileCacheHelper.get_GetKCPutMoneyCache() != "1")
                            {
                                base.SetUserDrawback_kl8(dataTable);
                            }
        ...
        public void get_oddsinfo(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataSet set2 = CallBLL.cz_play_kl8_bll.GetPlay(str, str5, str4);
                if (set2 == null)
                {
                    context.Response.End();
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        if (FileCacheHelper.get_GetKCPutMoneyCache() == "1")
                        {
                            ...
                            {
                                DataTable table7;
                                if (CacheHelper.GetCache("kc_drawback_FileCacheKey_kl8" + str15 + context.Session["user_name"].ToString()) != null)
                                {
                                    DataTable cache = CacheHelper.GetCache("kc_drawback_FileCacheKey_kl8" + str15 + context.Session["user_name"].ToString()) as DataTable;
                                ...
                                {
                                    drawbackByPlayIds = CallBLL.cz_drawback_kl8_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                }
                                else
                                {
                                    table7 = drawbackByPlayIds.Clone();
                                    table7 = CallBLL.cz_drawback_kl8_bll.GetDrawbackByPlayIds(str15, getUserModelInfo.get_u_name());
                                    if (table7 != null)
                                    {
                                        drawbackByPlayIds.Merge(table7);
                                    }
                        ...
                        {
                            drawbackByPlayIds = CacheHelper.GetCache("kc_drawback_FileCacheKey_kl8" + this.Session["user_name"].ToString()) as DataTable;
                        }
                        else
                        {
                            drawbackByPlayIds = CallBLL.cz_drawback_kl8_bll.GetDrawbackByPlayIds(str, getUserModelInfo.get_u_name());
                        }
                        ...
                        foreach (DataRow row2 in table3.Rows)
                        {
                            ...
                            if (str23 != "-")
                            {
                                base.GetOdds_KC(5, row2["odds_id"].ToString(), ref pl);
                            }
        ...
        public void get_openball(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataTable kCOpenBall = base.GetKCOpenBall(5);
                if (kCOpenBall != null)
                {
                    ...
                    string dateDiff = LSKeys.get_KL8_Phase_Interval().ToString() + "分鐘";
                    if (!(string.IsNullOrEmpty(str4) || string.IsNullOrEmpty(str5)))
                    {
                        dateDiff = Utils.GetDateDiff(str4, str5);
                    }
                    Dictionary<string, string> dictionary2 = new Dictionary<string, string>();
                    DataRow[] rowArray = base.GetLotteryList().Select(string.Format(" id={0} ", 5));
        ...
        public void get_ranklist(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                string str2 = "_kl8_jqkj";
                string str3 = "_kl8_lmcl";
                string str4 = "_kl8_cql";
                ...
                else
                {
                    ...
                    DataSet topPhase = CallBLL.cz_phase_kl8_bll.GetTopPhase(5);
                    if (topPhase != null)
                    {
                        ...
                        foreach (DataRow row in table.Rows)
                        {
                            ...
                            int num12 = Convert.ToInt32(row["n11"].ToString());
                            int num13 = Convert.ToInt32(row["n12"].ToString());
                            int num14 = Convert.ToInt32(row["n13"].ToString());
                            int num15 = Convert.ToInt32(row["n14"].ToString());
                            int num16 = Convert.ToInt32(row["n15"].ToString());
                            int num17 = Convert.ToInt32(row["n16"].ToString());
                            int num18 = Convert.ToInt32(row["n17"].ToString());
                            int num19 = Convert.ToInt32(row["n18"].ToString());
                            int num20 = Convert.ToInt32(row["n19"].ToString());
                            int num21 = Convert.ToInt32(row["n20"].ToString());
                            ...
                            collection.Add((num12 < 10) ? ("0" + num12) : num12.ToString());
                            collection.Add((num13 < 10) ? ("0" + num13) : num13.ToString());
                            collection.Add((num14 < 10) ? ("0" + num14) : num14.ToString());
                            collection.Add((num15 < 10) ? ("0" + num15) : num15.ToString());
                            collection.Add((num16 < 10) ? ("0" + num16) : num16.ToString());
                            collection.Add((num17 < 10) ? ("0" + num17) : num17.ToString());
                            collection.Add((num18 < 10) ? ("0" + num18) : num18.ToString());
                            collection.Add((num19 < 10) ? ("0" + num19) : num19.ToString());
                            collection.Add((num20 < 10) ? ("0" + num20) : num20.ToString());
                            collection.Add((num21 < 10) ? ("0" + num21) : num21.ToString());
                            str7 = (((((((((((((((((((num2 + num3) + num4) + num5) + num6) + num7) + num8) + num9) + num10) + num11) + num12) + num13) + num14) + num15) + num16) + num17) + num18) + num19) + num20) + num21).ToString();
                            if (Convert.ToInt32(str7) == 810)
                            {
                                str9 = "和";
                            }
                            else if ((Convert.ToInt32(str7) % 2) == 0)
                            {
                                str9 = "雙";
                            }
                            else
                            ...
                            else if (Convert.ToInt32(str7) < 810)
                            {
                                str8 = "小";
                            }
                            else
                            ...
                            while (num24 < 20)
                            {
                                if ((int.Parse(table.Rows[num]["n" + (num24 + 1)].ToString().Trim()) % 2) == 0)
                                {
                                    num23++;
                                }
                                else
                            ...
                            str10 = KL8Phase.get_cl_dsh(num22.ToString(), num23.ToString());
                            str10 = base.SetWordColor(str10);
                            int num25 = 0;
                            int num26 = 0;
                            for (num24 = 0; num24 < 20; num24++)
                            {
                                if (int.Parse(table.Rows[num]["n" + (num24 + 1)].ToString().Trim()) <= 40)
                                {
                                    num25++;
                                }
                                else
                            ...
                            str11 = KL8Phase.get_cl_qhh(num25.ToString(), num26.ToString());
                            str11 = base.SetWordColor(str11);
                            str12 = KL8Phase.get_cl_wh(str7.ToString());
                            dictionary2.Add("phase", str5);
                            dictionary2.Add("play_open_date", str6);
                            dictionary2.Add("draw_num", new List<string>(collection));
                            dictionary2.Add("total", new List<string> { str7, str9, str8, str10, str11, str12 });
                ...
                {
                    DataTable table2 = CallBLL.cz_phase_kl8_bll.GetChangLong().Tables[0];
                ...
                {
                    List<string> list5 = CallBLL.cz_phase_kl8_bll.PaihangList(str, 0x19);
                    List<string> list6 = new List<string> { "總和數", "總和大小", "前後和", "五行", "總和單雙", "單雙和" };
        ...
        {
            base.checkLogin();
            base.IsLotteryExist(5.ToString());
