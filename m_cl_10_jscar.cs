...
public class m_cl_10_jscar : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            string str = "_m_jscar_lmcl";
            string str2 = "_m_jscar_cql";
            ...
            if (!string.IsNullOrEmpty(str6) && ((str6 == "21") || (str6 == "18")))
            {
                ...
                {
                    List<string> list2 = CallBLL.cz_phase_jscar_bll.PaihangList_LMP("jscar_lmp", 10);
