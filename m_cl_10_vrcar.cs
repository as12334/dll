...
public class m_cl_10_vrcar : MemberPageBase_Mobile
{
    protected void output_cl_cql_lryl()
    {
        ...
        {
            string str = "_m_vrcar_lmcl";
            string str2 = "_m_vrcar_cql";
            ...
            if (!string.IsNullOrEmpty(str6) && ((str6 == "21") || (str6 == "18")))
            {
                ...
                {
                    List<string> list2 = CallBLL.cz_phase_vrcar_bll.PaihangList_LMP("vrcar_lmp", 10);
