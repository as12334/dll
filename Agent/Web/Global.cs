    ...
    public class Global : HttpApplication
    {
        ...
        private void Application_Error(object sender, EventArgs e)
        {
            ...
            if (str.Trim() == "true")
            {
                ...
                {
                    str4 = HttpContext.Current.Session["user_name"].ToString() + "_" + HttpContext.Current.Session["child_user_name"].ToString();
                }
        ...
        private void DelOldErrorLog()
        {
            try
            {
                string path = FileCacheHelper.GetWebRootPath(2, "publics") + @"\LogError";
