namespace Agent.Web.m.Account
{
    ...
    public class hy_edit : MemberPageBase_Mobile
    {
        ...
        private void getMemberDetail(ref string strResult)
        {
            ...
            this.d_up_six_kind = dictionary2["six_kind"];
            ...
            if (str2 == "view")
            {
                if (flag2 && flag3)
                {
                    ...
                    dictionary4.Add("supType", this.d_up_u_type);
                ...
                else if (flag2)
                {
                    ...
                    dictionary5.Add("supType", this.d_up_u_type);
                ...
                else if (flag3)
                {
                    ...
                    dictionary6.Add("supType", this.d_up_u_type);
