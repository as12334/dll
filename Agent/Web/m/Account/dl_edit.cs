namespace Agent.Web.m.Account
{
    ...
    public class dl_edit : MemberPageBase_Mobile
    {
        protected string currentLimit = "0";
        ...
        protected string sltLimit = "0";
        protected string txtLimit = "0";
        ...
        private void AddUser()
        {
            ...
            string message = "";
            if (!base.ValidParamByUserEditPhone("dl", ref message, null, this.lottrty_six, this.lottrty_kc))
            {
            ...
            else
            {
                ...
                {
                    base.noRightOptMsg(string.Format("代理下線人數不能小於 {0} 人", this.currentLimit));
                }
            }
            ...
            if (!string.IsNullOrEmpty(this.lottrty_six))
            {
                ...
                num2 = double.Parse(s) - double.Parse(this.d_six_credit);
            ...
            if (!string.IsNullOrEmpty(this.lottrty_kc))
            {
                ...
                num3 = double.Parse(str11) - double.Parse(this.d_kc_credit);
            ...
            if (CallBLL.cz_users_bll.UpdateUserInfo(_users, flag2, flag3, flag4, flag5, this.d_up_u_type, this.d_up_u_name))
            {
                ...
                base.Un_User_Lock(rateKCByUserName.get_fgs_name());
                base.successOptMsg("已經成功修改代理！");
            }
            else
            {
                base.Un_User_Lock(rateKCByUserName.get_fgs_name());
                base.noRightOptMsg("修改代理失敗！");
            }
        }
