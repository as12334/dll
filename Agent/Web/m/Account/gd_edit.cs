namespace Agent.Web.m.Account
{
    ...
    public class gd_edit : MemberPageBase_Mobile
    {
        ...
        private void AddUser()
        {
            ...
            string message = "";
            if (!base.ValidParamByUserEditPhone("gd", ref message, null, this.lottrty_six, this.lottrty_kc))
            {
            ...
            if (CallBLL.cz_users_bll.UpdateUserInfo(_users, flag2, flag3, flag4, flag5, this.d_up_u_type, this.d_up_u_name))
            {
                ...
                base.Un_User_Lock(rateKCByUserName.get_fgs_name());
                base.successOptMsg("已經成功修改股東！");
            }
            else
            {
                base.Un_User_Lock(rateKCByUserName.get_fgs_name());
                base.noRightOptMsg("修改股東失敗！");
            }
        }
