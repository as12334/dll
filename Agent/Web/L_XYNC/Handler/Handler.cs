namespace Agent.Web.L_XYNC.Handler
{
    ...
    public class Handler : BaseHandler
    {
        ...
        private void FGSBH(agent_userinfo_session userModel, agent_kc_rate kc_rate, string kc_kind, HttpContext context, string phase_id, string phase, string play_id, string odds_id, string zj_ds, string fgs_ds, string gd_ds, string zd_ds, string dl_ds, string hy_ds, string checkcode)
        {
            if (!string.IsNullOrEmpty(kc_rate.get_fgsname()))
            {
                ...
                {
                    double num = 1.0;
                    DataTable autosale = CallBLL.cz_autosale_xync_bll.GetAutosale(kc_rate.get_fgsname(), play_id);
                    if (((autosale != null) && (autosale.Rows.Count > 0)) && autosale.Rows[0]["sale_type"].ToString().Equals("0"))
                    {
                        DataTable table3 = CallBLL.cz_bet_kc_bll.GetSZZTBHByOddsid("fgs", kc_rate.get_fgsname(), odds_id, phase_id, 3);
                        if ((double.Parse(table3.Rows[0]["szzt"].ToString()) - num) > double.Parse(autosale.Rows[0]["max_money"].ToString()))
                        {
                            ...
                            DataSet playOddsInfo = CallBLL.cz_play_xync_bll.GetPlayOddsInfo(odds_id);
                            ...
                            base.GetOdds_KC_EX(3, playOddsInfo.Tables[0].Rows[0]["current_odds"].ToString().Trim(), str4, ref s, odds_id);
                            ...
                            CallBLL.cz_odds_xync_bll.Agent_UpdateGrandTotal(num6.ToString(), odds_id);
                            ...
                            if ((num9 > 1.0) && (num8 >= 1.0))
                            {
                                ...
                                CallBLL.cz_odds_xync_bll.UpdateGrandTotalCurrentOdds(num10.ToString(), (num7 - (num8 * num9)).ToString(), odds_id.ToString());
                                ...
                                _log.set_l_name(LSKeys.get_XYNC_Name());
        ...
        protected void FGSBH_LM(agent_userinfo_session userModel, agent_kc_rate kc_rate, string kc_kind, HttpContext context, string phase_id, string phase, string play_id, string odds_id, string zj_ds, string fgs_ds, string gd_ds, string zd_ds, string dl_ds, string hy_ds, string checkcode)
        {
            if (!string.IsNullOrEmpty(kc_rate.get_fgsname()))
            {
                ...
                if ((isAllowSale.Rows[0]["kc_allow_sale"] != null) && (Convert.ToInt32(isAllowSale.Rows[0]["kc_allow_sale"]) != 0))
                {
                    ...
                    if (((autosale != null) && (autosale.Rows.Count > 0)) && autosale.Rows[0]["sale_type"].ToString().Equals("0"))
                    {
                        DataTable table3 = CallBLL.cz_bet_kc_bll.GetBHGroup("fgs", kc_rate.get_fgsname(), odds_id, phase_id, autosale.Rows[0]["max_money"].ToString(), num.ToString(), 3);
                        if ((table3 != null) && (table3.Rows.Count > 0))
                        {
                            ...
                            base.GetOdds_KC_EX(3, playOddsInfo.Tables[0].Rows[0]["current_odds"].ToString().Trim(), str5, ref str2, odds_id);
                            if (userModel.get_kc_op_odds().Equals(1))
                            {
                                str2 = str6;
                            }
                            ...
                            foreach (DataRow row in table3.Rows)
                            {
                                ...
                                _kc.set_bet_val(str7);
                                _kc.set_bet_wt((num5 > 0.0) ? (str8 + "~" + str2) : "");
                                _kc.set_odds(str2);
                                ...
                                double num7 = (double.Parse(num4.ToString()) * double.Parse(s)) / 100.0;
                                CallBLL.cz_odds_xync_bll.Agent_UpdateGrandTotal(num7.ToString(), odds_id);
                                ...
                                if ((num10 >= 1.0) && (num9 >= 1.0))
                                {
                                    ...
                                    CallBLL.cz_odds_xync_bll.UpdateGrandTotalCurrentOdds(num11.ToString(), (num8 - (num9 * num10)).ToString(), odds_id.ToString());
                                    cz_system_log _log = new cz_system_log();
                                    _log.set_user_name("系統");
                                    _log.set_children_name("");
                                    _log.set_category(playOddsInfo.Tables[0].Rows[0]["category"].ToString());
                                    ...
                                    _log.set_new_val((double.Parse(str9) - num11).ToString());
                                    _log.set_ip(LSRequest.GetIP());
                                    _log.set_add_time(DateTime.Now);
                                    _log.set_note("系統自動降賠");
                                    _log.set_type_id(Convert.ToInt32((LSEnums.LogTypeID) 0));
                                    ...
                                    _odds.set_new_odds((double.Parse(str9) - num11).ToString());
                                    CallBLL.cz_jp_odds_bll.Add(_odds);
                                }
                                double num13 = 0.0;
                                double num14 = 0.0;
                                string[] strArray = str2.Split(new char[] { ',' });
                                num13 = double.Parse(strArray[0].ToString());
                                if (strArray.Length > 1)
                                {
                                    num14 = double.Parse(strArray[1].ToString());
                                }
                                double num15 = 0.0;
                                double num16 = 0.0;
                                string[] strArray2 = str6.Split(new char[] { ',' });
                                num15 = double.Parse(strArray2[0].ToString());
                                if (strArray2.Length > 1)
                                {
                                    num16 = double.Parse(strArray2[1].ToString());
                                }
                                cz_splitgroup_xync _xync = new cz_splitgroup_xync();
                                _xync.set_odds_id(new int?(int.Parse(odds_id)));
                                _xync.set_item_money(new decimal?(Convert.ToDecimal(num4)));
                                _xync.set_odds1(new decimal?(Convert.ToDecimal(num13.ToString())));
                                _xync.set_odds2(new decimal?(Convert.ToDecimal(num14.ToString())));
                                _xync.set_bet_id(new int?(num6));
                                _xync.set_item(str7);
                                _xync.set_odds1_zj(new decimal?(Convert.ToDecimal(num15.ToString())));
                                _xync.set_odds2_zj(new decimal?(Convert.ToDecimal(num16.ToString())));
                                CallBLL.cz_splitgroup_xync_bll.Agent_AddSplitGroup(_xync);
                            }
                        }
                    }
                }
        ...
        private void GDBH(agent_userinfo_session userModel, agent_kc_rate kc_rate, string kc_kind, HttpContext context, string phase_id, string phase, string play_id, string odds_id, string zj_ds, string fgs_ds, string gd_ds, string zd_ds, string dl_ds, string hy_ds, string checkcode)
        {
            if (!string.IsNullOrEmpty(kc_rate.get_gdname()))
            {
                ...
                {
                    double num = 1.0;
                    DataTable autosale = CallBLL.cz_autosale_xync_bll.GetAutosale(kc_rate.get_gdname(), play_id);
                    if (((autosale != null) && (autosale.Rows.Count > 0)) && autosale.Rows[0]["sale_type"].ToString().Equals("0"))
                    {
                        DataTable table3 = CallBLL.cz_bet_kc_bll.GetSZZTBHByOddsid("gd", kc_rate.get_gdname(), odds_id, phase_id, 3);
                        if ((double.Parse(table3.Rows[0]["szzt"].ToString()) - num) > double.Parse(autosale.Rows[0]["max_money"].ToString()))
                        {
                            double num2 = double.Parse(table3.Rows[0]["szzt"].ToString());
                            double num3 = double.Parse(autosale.Rows[0]["max_money"].ToString());
                            ...
                            CallBLL.cz_odds_xync_bll.Agent_UpdateGrandTotal(num8.ToString(), odds_id);
                            ...
                            if ((num11 > 1.0) && (num10 >= 1.0))
                            {
                                ...
                                CallBLL.cz_odds_xync_bll.UpdateGrandTotalCurrentOdds(num12.ToString(), (num9 - (num10 * num11)).ToString(), odds_id.ToString());
                                cz_system_log _log = new cz_system_log();
                                _log.set_user_name("系統");
                                _log.set_children_name("");
                                _log.set_category(playOddsInfo.Tables[0].Rows[0]["category"].ToString());
        ...
        protected void GDBH_LM(agent_userinfo_session userModel, agent_kc_rate kc_rate, string kc_kind, HttpContext context, string phase_id, string phase, string play_id, string odds_id, string zj_ds, string fgs_ds, string gd_ds, string zd_ds, string dl_ds, string hy_ds, string checkcode)
        {
            if (!string.IsNullOrEmpty(kc_rate.get_gdname()))
            {
                ...
                if ((isAllowSale.Rows[0]["kc_allow_sale"] != null) && (Convert.ToInt32(isAllowSale.Rows[0]["kc_allow_sale"]) != 0))
                {
                    ...
                    if (((autosale != null) && (autosale.Rows.Count > 0)) && autosale.Rows[0]["sale_type"].ToString().Equals("0"))
                    {
                        DataTable table3 = CallBLL.cz_bet_kc_bll.GetBHGroup("gd", kc_rate.get_gdname(), odds_id, phase_id, autosale.Rows[0]["max_money"].ToString(), num.ToString(), 3);
                        if ((table3 != null) && (table3.Rows.Count > 0))
                        {
                            zd_ds = gd_ds;
                            string s = kc_rate.get_zjzc();
                            ...
                            base.GetOdds_KC_EX(3, playOddsInfo.Tables[0].Rows[0]["current_odds"].ToString().Trim(), str6, ref str3, odds_id);
                            string str8 = "";
                            foreach (DataRow row in table3.Rows)
                            {
                                double num4 = Math.Floor(double.Parse(row["bhl"].ToString().Trim()));
                                str8 = row["item"].ToString().Trim();
                                string str9 = "";
                                double num5 = 0.0;
                                cz_bet_kc _kc = new cz_bet_kc();
                                _kc.set_order_num(Utils.GetOrderNumber());
                                ...
                                _kc.set_bet_val(str8);
                                _kc.set_bet_wt((num5 > 0.0) ? (str9 + "~" + str3) : "");
                                _kc.set_odds(str3);
                                _kc.set_amount(new decimal?(Convert.ToDecimal(num4.ToString())));
                                _kc.set_profit(0);
                                _kc.set_unit_cnt(1);
                                ...
                                _kc.set_zd_rate(0f);
                                _kc.set_gd_rate(0f);
                                _kc.set_fgs_rate(float.Parse(str2));
                                _kc.set_zj_rate(float.Parse(s));
                                _kc.set_dl_name("");
                                _kc.set_zd_name("");
                                _kc.set_gd_name(kc_rate.get_gdname());
                                ...
                                if ((num10 >= 1.0) && (num9 >= 1.0))
                                {
                                    ...
                                    _log.set_new_val((double.Parse(str10) - num11).ToString());
                                    _log.set_ip(LSRequest.GetIP());
                                    _log.set_add_time(DateTime.Now);
                                    _log.set_note("系統自動降賠");
                                    _log.set_type_id(Convert.ToInt32((LSEnums.LogTypeID) 0));
                                    ...
                                    _odds.set_new_odds((double.Parse(str10) - num11).ToString());
                                    CallBLL.cz_jp_odds_bll.Add(_odds);
                                }
                                double num13 = 0.0;
                                double num14 = 0.0;
        ...
        public void get_clyl(HttpContext context, ref string strResult)
        {
            ...
            string str = "_xync_lmcl";
            string str2 = "_xync_lryl";
            ...
            {
                DataSet set = CallBLL.cz_phase_xync_bll.Agent_GetTopPhase(40);
                int index = 0;
                ...
                if ((set != null) && (set.Tables.Count > 0))
                {
                    ...
                    for (int i = 0; i < 20; i++)
                    {
                        ...
                        {
                            if ((str3 == null) || (str3.IndexOf(strArray2[i].ToString()) > -1))
                            {
                                break;
                            }
                            num2++;
            ...
            {
                DataTable table2 = CallBLL.cz_phase_xync_bll.GetChangLong().Tables[0];
        ...
        public void get_lmbhlist(HttpContext context, ref string strResult)
        {
            ...
            if (!string.IsNullOrEmpty(str7))
            {
                ...
                DataSet set = CallBLL.cz_bet_kc_bll.GetLMBHList(str10, str11, int.Parse(s), Convert.ToInt32(str6), str9, model.get_zjname().ToString(), Convert.ToInt32(str7), 3, "xync", str4);
        ...
        public void get_oddsinfo(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataSet set = CallBLL.cz_play_xync_bll.Agent_GetPlay(str4, str10, str9, str7);
                if (set == null)
                {
                    context.Response.End();
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        Dictionary<string, object> dictionary2 = base.GetOdds_KC(3, oddsDT, str11, str12, null);
                        ...
                        DataSet set2 = CallBLL.cz_bet_kc_bll.GetSZSZ(str9, str10, int.Parse(s), Convert.ToInt32(str17), 3, str4, str21, model.get_zjname().ToString(), num, "xync", str6, null, null);
                        DataTable table4 = null;
                        if (str8.Equals("1"))
                        {
                            int num22 = 3;
                            table4 = CallBLL.cz_bet_kc_bll.GetBHSZZT(str10, str9, str17, str21, str4, model.get_zjname().ToString(), num, num22.ToString(), "xync", str6, null, null).Tables[0];
                        }
                        ...
                        DataSet set4 = CallBLL.cz_bet_kc_bll.GetSZSZCount(str9, str10, int.Parse(s), Convert.ToInt32(str17), 3, "xync", str6, null, null);
                        if ((set4 != null) && (set4.Tables.Count > 0))
                        {
                            ...
                            dictionary4.Add("78", Math.Floor(num18));
                            dictionary4.Add("79", Math.Floor(num19));
                            dictionary4.Add("80", Math.Floor(num20));
                        }
        ...
        public void get_opennumber(HttpContext context, ref string strResult)
        {
            ...
            {
                new List<object>();
                DataTable openNumber = base.GetOpenNumber(3, null);
                Dictionary<string, object> dictionary2 = new Dictionary<string, object>();
        ...
        public void operate_adds(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                string str12;
                double num39;
                cz_odds_xync oldModel = null;
                if ((str3.Equals("1") || str3.Equals("2")) || (str3.Equals("3") || str3.Equals("4")))
                {
                    oldModel = CallBLL.cz_odds_xync_bll.GetModel(Convert.ToInt32(str4));
                    if (oldModel == null)
                    {
                        result.set_success(400);
                        result.set_tipinfo(PageBase.GetMessageByCache("u100008", "MessageHint"));
                ...
                if (!str3.Equals("1") && !str3.Equals("2"))
                {
                    if (str3.Equals("3"))
                    {
                        ...
                        else if (CallBLL.cz_odds_xync_bll.UpdateCurrentOdds(Convert.ToInt32(str4), Convert.ToDouble(s), str3) > 0)
                        {
                            cz_odds_xync newModel = CallBLL.cz_odds_xync_bll.GetModel(Convert.ToInt32(str4));
                            base.xync_log(oldModel, newModel, str3);
                            ...
                            DataTable table2 = CallBLL.cz_phase_xync_bll.IsPhaseClose();
                    ...
                    else
                    {
                        ...
                        {
                            oldTable = CallBLL.cz_odds_xync_bll.GetOddsInfoByID(str4.ToString());
                        }
                        if (str3.Equals("5") || str3.Equals("6"))
                        {
                            ...
                            Label_0B49:
                                ...
                                if (CallBLL.cz_odds_xync_bll.UpdateCurrentOddsList(row["odds_id"].ToString(), str3.Equals("5") ? num24 : -num24, "5") > 0)
                                {
                                    num19++;
                                }
                            }
                            if (num19 > 0)
                            {
                                DataTable oddsInfoByID = CallBLL.cz_odds_xync_bll.GetOddsInfoByID(str4);
                                base.xync_kjj_log(oldTable, oddsInfoByID, str3);
                                ...
                                foreach (DataRow row2 in oddsInfoByID.Rows)
                                {
                                    ...
                                    DataTable table5 = CallBLL.cz_phase_xync_bll.IsPhaseClose();
                        ...
                        else if (str3.Equals("7"))
                        {
                            ...
                            foreach (DataRow row3 in oldTable.Rows)
                            {
                                ...
                                if (CallBLL.cz_odds_xync_bll.UpdateCurrentOddsList(row3["odds_id"].ToString(), num34, "7") > 0)
                                {
                                    num29++;
                                }
                            }
                            if (num29 > 0)
                            {
                                DataTable newTable = CallBLL.cz_odds_xync_bll.GetOddsInfoByID(str4);
                                base.xync_kjj_log(oldTable, newTable, str3);
                                ...
                                foreach (DataRow row4 in newTable.Rows)
                                {
                                    ...
                                    DataTable table7 = CallBLL.cz_phase_xync_bll.IsPhaseClose();
                ...
                else
                {
                    ...
                    else if (CallBLL.cz_odds_xync_bll.UpdateCurrentOdds(Convert.ToInt32(str4), str3.Equals("1") ? Convert.ToDouble(str6) : -Convert.ToDouble(str6), str3) > 0)
                    {
                        cz_odds_xync _xync2 = CallBLL.cz_odds_xync_bll.GetModel(Convert.ToInt32(str4));
                        base.xync_log(oldModel, _xync2, str3);
                        double num7 = Convert.ToDouble(_xync2.get_current_odds());
                        double num8 = Convert.ToDouble(_xync2.get_max_odds());
                        double num9 = Convert.ToDouble(_xync2.get_min_odds());
                        double num10 = 0.0;
                        if (str5.Equals("A"))
                        {
                            num10 = Convert.ToDouble(_xync2.get_a_diff());
                        }
                        else if (str5.Equals("B"))
                        {
                            num10 = Convert.ToDouble(_xync2.get_b_diff());
                        }
                        else if (str5.Equals("C"))
                        {
                            num10 = Convert.ToDouble(_xync2.get_c_diff());
                        }
                        num39 = num7 + num10;
                        num7 = double.Parse(num39.ToString());
                        string str8 = _xync2.get_is_open().ToString();
                        Dictionary<string, object> dictionary2 = new Dictionary<string, object>();
                        Dictionary<string, object> dictionary3 = new Dictionary<string, object>();
                        ...
                        DataTable table = CallBLL.cz_phase_xync_bll.IsPhaseClose();
        ...
        public void operate_CloseOpen(HttpContext context, ref string strResult)
        {
            ...
            if (str3.Equals("4"))
            {
                ...
                else
                {
                    ...
                    {
                        int num = CallBLL.cz_odds_xync_bll.UpdateIsOpen(Convert.ToInt32(str4));
                        result.set_success(200);
                        if (num > 0)
                        {
                            base.kc_openclose_log(str4, str3, str5, 3, LSRequest.qq("playpage"));
                            strResult = JsonHandle.ObjectToJson(result);
                        }
                        else
                        {
            ...
            else if (str3.Equals("8"))
            {
                ...
                else
                {
                    ...
                    {
                        int num2 = CallBLL.cz_odds_xync_bll.UpdateIsOpenList(str4, Convert.ToInt32(str5));
                        result.set_success(200);
                        if (num2 > 0)
                        {
                            base.kc_openclose_log(str4, str3, str5, 3, LSRequest.qq("playpage"));
            ...
            else if (str3.Equals("61") || str3.Equals("62"))
            {
                ...
                {
                    int num3 = CallBLL.cz_odds_xync_bll.UpdateIsOpenList(str3, str6, str4, str5);
                    result.set_success(200);
                    if (num3 > 0)
                    {
                        base.kc_openclose_log(str4, str3, str5, 3, LSRequest.qq("playpage"));
        ...
        public void operate_odds_wt(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                {
                    _xync = CallBLL.cz_odds_xync_bll.GetModel(Convert.ToInt32(str4));
                    if (_xync == null)
                    {
                        result.set_success(400);
                        result.set_tipinfo(PageBase.GetMessageByCache("u100008", "MessageHint"));
                ...
                if (!str3.Equals("1") && !str3.Equals("2"))
                {
                    if (str3.Equals("3"))
                    {
                        double num16 = double.Parse(_xync.get_current_odds());
                        double num17 = Convert.ToDouble(_xync.get_max_odds());
                        double num18 = Convert.ToDouble(_xync.get_min_odds());
                        double num19 = 0.0;
                        if (str8.Equals("A"))
                        {
                            num19 = Convert.ToDouble(_xync.get_a_diff());
                        }
                        else if (str8.Equals("B"))
                        {
                            num19 = Convert.ToDouble(_xync.get_b_diff());
                        }
                        else if (str8.Equals("C"))
                        {
                            num19 = Convert.ToDouble(_xync.get_c_diff());
                        }
                        base.GetFgsWTTable(3);
                        double wtvalue = 0.0;
                        base.GetOperate_KC(3, str4, ref wtvalue);
                        double num21 = num16;
                        double num22 = num18;
                        num60 = num16 + wtvalue;
                        ...
                        if (Convert.ToDouble(s) < num22)
                        {
                            result.set_success(400);
                            num60 = num22 + num19;
                            result.set_tipinfo(string.Format(PageBase.GetMessageByCache("u100023", "MessageHint"), _xync.get_play_name() + "【" + _xync.get_put_amount() + "】", double.Parse(num60.ToString())));
                            strResult = JsonHandle.ObjectToJson(result);
                        }
                        else if (Convert.ToDouble(s) > num21)
                        {
                            result.set_success(400);
                            num60 = num21 + num19;
                            result.set_tipinfo(string.Format(PageBase.GetMessageByCache("u100055", "MessageHint"), _xync.get_play_name() + "【" + _xync.get_put_amount() + "】", double.Parse(num60.ToString())));
                            strResult = JsonHandle.ObjectToJson(result);
                        }
                        ...
                        else
                        {
                            ...
                            DataTable oddsWTbyFGS = CallBLL.cz_odds_wt_xync_bll.GetOddsWTbyFGS(str4, str);
                            num61 = 3;
                            base.Add_FgsOddsWT_Lock(num61.ToString(), str, str4);
                            int num27 = CallBLL.cz_odds_wt_xync_bll.UpdateFgsWTOdds(Convert.ToInt32(str4), num26, str3, str);
                            num61 = 3;
                            base.Del_FgsOddsWT_Lock(num61.ToString(), str, str4);
                            if (num27 > 0)
                            {
                                wtvalue = 0.0;
                                CacheHelper.RemoveAllCache("fgs_wt_FileCacheKey" + context.Session["user_name"].ToString() + 3);
                                FileCacheHelper.UpdateFGSWTFile(3);
                                base.GetOperate_KC(3, str4, ref wtvalue);
                                cz_odds_xync _xync3 = CallBLL.cz_odds_xync_bll.GetModel(Convert.ToInt32(str4));
                                base.fgs_opt_kc_log(oddsWTbyFGS, CallBLL.cz_odds_wt_xync_bll.GetOddsWTbyFGS(str4, str), str3, str, str4, 3);
                                double num28 = Convert.ToDouble(_xync3.get_current_odds());
                                Convert.ToDouble(_xync3.get_max_odds());
                                double num29 = Convert.ToDouble(_xync3.get_min_odds());
                                double num30 = 0.0;
                                if (str8.Equals("A"))
                                {
                                    num30 = Convert.ToDouble(_xync3.get_a_diff());
                                }
                                else if (str8.Equals("B"))
                                {
                                    num30 = Convert.ToDouble(_xync3.get_b_diff());
                                }
                                else if (str8.Equals("C"))
                                {
                                    num30 = Convert.ToDouble(_xync3.get_c_diff());
                                }
                                ...
                                string str10 = _xync3.get_is_open().ToString();
                                Dictionary<string, object> dictionary4 = new Dictionary<string, object>();
                                Dictionary<string, object> dictionary5 = new Dictionary<string, object>();
                                ...
                                dictionary5.Add("plx", new List<double>());
                                DataTable table4 = CallBLL.cz_phase_xync_bll.IsPhaseClose();
                    ...
                    else
                    {
                        ...
                        if ((str3.Equals("5") || str3.Equals("6")) || str3.Equals("7"))
                        {
                            oddsInfoByID = CallBLL.cz_odds_xync_bll.GetOddsInfoByID(str4.ToString());
                        }
                        if (str3.Equals("5") || str3.Equals("6"))
                        {
                            if (string.IsNullOrEmpty(str6))
                            ...
                            foreach (DataRow row in oddsInfoByID.Rows)
                            {
                                ...
                                base.GetFgsWTTable(3);
                                double num35 = 0.0;
                                base.GetOperate_KC(3, row["odds_id"].ToString(), ref num35);
                                num60 = num32 + num35;
                            ...
                            Label_105F:
                                ...
                                DataTable table6 = CallBLL.cz_odds_wt_xync_bll.GetOddsWTbyFGS(str4, str);
                                num61 = 3;
                                base.Add_FgsOddsWT_Lock(num61.ToString(), str, row["odds_id"].ToString());
                                int num40 = CallBLL.cz_odds_wt_xync_bll.UpdateFgsWTOddsList(row["odds_id"].ToString(), str3.Equals("5") ? Convert.ToDecimal(num39) : -Convert.ToDecimal(num39), "5", str);
                                num61 = 3;
                                base.Del_FgsOddsWT_Lock(num61.ToString(), str, row["odds_id"].ToString());
                                if (num40 > 0)
                                {
                                    base.fgs_opt_kc_log(table6, CallBLL.cz_odds_wt_xync_bll.GetOddsWTbyFGS(str4, str), str3, str, str4, 3);
                                    num31++;
                                }
                            }
                            if (num31 > 0)
                            {
                                CacheHelper.RemoveAllCache("fgs_wt_FileCacheKey" + context.Session["user_name"].ToString() + 3);
                                FileCacheHelper.UpdateFGSWTFile(3);
                                DataTable table7 = CallBLL.cz_odds_xync_bll.GetOddsInfoByID(str4);
                                Dictionary<string, object> dictionary6 = new Dictionary<string, object>();
                                foreach (DataRow row2 in table7.Rows)
                                {
                                    double num41 = 0.0;
                                    base.GetOperate_KC(3, row2["odds_id"].ToString(), ref num41);
                                    cz_odds_xync _xync4 = CallBLL.cz_odds_xync_bll.GetModel(Convert.ToInt32(row2["odds_id"].ToString()));
                                    double num42 = Convert.ToDouble(_xync4.get_current_odds());
                                    double num43 = Convert.ToDouble(_xync4.get_max_odds());
                                    double num44 = Convert.ToDouble(_xync4.get_min_odds());
                                    double num45 = 0.0;
                                    if (str8.Equals("A"))
                                    {
                                        num45 = Convert.ToDouble(_xync4.get_a_diff());
                                    }
                                    else if (str8.Equals("B"))
                                    {
                                        num45 = Convert.ToDouble(_xync4.get_b_diff());
                                    }
                                    else if (str8.Equals("C"))
                                    {
                                        num45 = Convert.ToDouble(_xync4.get_c_diff());
                                    }
                                    num60 = num42 + num45;
                                    ...
                                    dictionary7.Add("plx", new List<double>());
                                    DataTable table8 = CallBLL.cz_phase_xync_bll.IsPhaseClose();
                        ...
                        else if (str3.Equals("7"))
                        {
                            ...
                            foreach (DataRow row3 in oddsInfoByID.Rows)
                            {
                                ...
                                base.GetFgsWTTable(3);
                                double num49 = 0.0;
                                base.GetOperate_KC(3, row3["odds_id"].ToString(), ref num49);
                                num60 = num46 + num49;
                                double.Parse(num60.ToString());
                                num60 = num46 + num48;
                                double.Parse(num60.ToString());
                            ...
                            DataTable table9 = CallBLL.cz_odds_wt_xync_bll.GetOddsWTbyFGS(str4, str);
                            num61 = 3;
                            base.Add_FgsOddsWT_Lock(num61.ToString(), str, str4);
                            int num54 = CallBLL.cz_odds_wt_xync_bll.UpdateFgsWTOddsInputList(str4, dictionary8, str);
                            num61 = 3;
                            base.Del_FgsOddsWT_Lock(num61.ToString(), str, str4);
                            if (num54 > 0)
                            {
                                CacheHelper.RemoveAllCache("fgs_wt_FileCacheKey" + context.Session["user_name"].ToString() + 3);
                                FileCacheHelper.UpdateFGSWTFile(3);
                                DataTable table10 = CallBLL.cz_odds_xync_bll.GetOddsInfoByID(str4);
                                base.fgs_opt_kc_log(table9, CallBLL.cz_odds_wt_xync_bll.GetOddsWTbyFGS(str4, str), str3, str, str4, 3);
                                Dictionary<string, object> dictionary9 = new Dictionary<string, object>();
                                foreach (DataRow row4 in table10.Rows)
                                {
                                    double num55 = 0.0;
                                    base.GetOperate_KC(3, row4["odds_id"].ToString(), ref num55);
                                    ...
                                    DataTable table11 = CallBLL.cz_phase_xync_bll.IsPhaseClose();
                ...
                {
                    double num = double.Parse(_xync.get_current_odds());
                    double num2 = Convert.ToDouble(_xync.get_max_odds());
                    double num3 = Convert.ToDouble(_xync.get_min_odds());
                    double num4 = 0.0;
                    if (str8.Equals("A"))
                    {
                        num4 = Convert.ToDouble(_xync.get_a_diff());
                    }
                    else if (str8.Equals("B"))
                    {
                        num4 = Convert.ToDouble(_xync.get_b_diff());
                    }
                    else if (str8.Equals("C"))
                    {
                        num4 = Convert.ToDouble(_xync.get_c_diff());
                    }
                    base.GetFgsWTTable(3);
                    double num5 = 0.0;
                    base.GetOperate_KC(3, str4, ref num5);
                    double num6 = num;
                    double num7 = num3;
                    num60 = num + num5;
                    ...
                    {
                        DataTable table = CallBLL.cz_odds_wt_xync_bll.GetOddsWTbyFGS(str4, str);
                        num61 = 3;
                        base.Add_FgsOddsWT_Lock(num61.ToString(), str, str4);
                        int num12 = CallBLL.cz_odds_wt_xync_bll.UpdateFgsWTOdds(Convert.ToInt32(str4), str3.Equals("1") ? decimal.Parse(str6) : -decimal.Parse(str6), str3, str);
                        base.Del_FgsOddsWT_Lock(3.ToString(), str, str4);
                        if (num12 > 0)
                        {
                            num5 = 0.0;
                            CacheHelper.RemoveAllCache("fgs_wt_FileCacheKey" + context.Session["user_name"].ToString() + 3);
                            ...
                            base.GetOperate_KC(3, str4, ref num5);
                            cz_odds_xync _xync2 = CallBLL.cz_odds_xync_bll.GetModel(Convert.ToInt32(str4));
                            base.fgs_opt_kc_log(table, CallBLL.cz_odds_wt_xync_bll.GetOddsWTbyFGS(str4, str), str3, str, str4, 3);
                            double num13 = Convert.ToDouble(_xync2.get_current_odds());
                            Convert.ToDouble(_xync2.get_max_odds());
                            double num14 = Convert.ToDouble(_xync2.get_min_odds());
                            double num15 = 0.0;
                            if (str8.Equals("A"))
                            {
                                num15 = Convert.ToDouble(_xync2.get_a_diff());
                            }
                            else if (str8.Equals("B"))
                            {
                                num15 = Convert.ToDouble(_xync2.get_b_diff());
                            }
                            else if (str8.Equals("C"))
                            {
                                num15 = Convert.ToDouble(_xync2.get_c_diff());
                            }
                            ...
                            string str9 = _xync2.get_is_open().ToString();
                            Dictionary<string, object> dictionary2 = new Dictionary<string, object>();
                            Dictionary<string, object> dictionary3 = new Dictionary<string, object>();
        ...
        public void user_allow_sale(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataTable phaseByPID = CallBLL.cz_phase_xync_bll.GetPhaseByPID(s);
                ...
                else
                {
                    ...
                    int num27 = 0;
                    while (num27 < strArray8.Length)
                    {
                        string str29;
                        cz_bet_kc _kc2;
                        string str38;
                        string str11 = strArray8[num27];
                        string str12 = strArray2[index];
                        bool flag = false;
                        string[] strArray3 = "329,330,331,1181,1202,1203".Split(new char[] { ',' });
                        ...
                        if (flag)
                        {
                            ...
                            int num29 = 3;
                            table2 = CallBLL.cz_bet_kc_bll.GetSZZT(model.get_u_name(), model.get_u_type().Trim(), str4, s, true, str7, num29.ToString(), "xync");
                        }
                        else
                        {
                            table2 = CallBLL.cz_bet_kc_bll.GetSZZT(model.get_u_name(), model.get_u_type().Trim(), str4, s, false, "", 3.ToString(), "xync");
                        }
                        ...
                        DataTable table3 = base.GetUserDrawback_xync();
                        DataSet playOddsInfo = CallBLL.cz_play_xync_bll.GetPlayOddsInfo(str11);
                        ...
                        string str20 = playOddsInfo.Tables[0].Rows[0]["play_name"].ToString();
                        string str21 = playOddsInfo.Tables[0].Rows[0][str16.ToUpper() + "_diff"].ToString().Trim();
                        double num30 = double.Parse(str18) + double.Parse(str21);
                        string str22 = num30.ToString();
                        base.GetOdds_KC_EX(3, playOddsInfo.Tables[0].Rows[0]["current_odds"].ToString().Trim(), str21, ref str18, str11);
                    ...
                    Label_0BD4:
                        ...
                        string[] source = Utils.longnumbersmallten(str7.Replace("-", "")).Split(new char[] { ',' });
                        ...
                        _kc.set_bet_val(str7);
                        _kc.set_bet_wt((num8 > 0.0) ? (str31 + "~" + str18) : "");
                        _kc.set_odds(str18);
                    ...
                    Label_11DE:
                        ...
                        int num9 = 0;
                        CallBLL.cz_bet_kc_bll.AddBetByBH(_kc, ref num9);
                        double num10 = (double.Parse(str12) * num3) / 100.0;
                        CallBLL.cz_odds_xync_bll.Agent_UpdateGrandTotal(num10.ToString(), str11);
                        double num11 = double.Parse(playOddsInfo.Tables[0].Rows[0]["grand_total"].ToString()) + num10;
                        double num12 = double.Parse(playOddsInfo.Tables[0].Rows[0]["downbase"].ToString());
                        double num13 = Math.Floor((double) (num11 / num12));
                        if ((num13 >= 1.0) && (num12 >= 1.0))
                        {
                            double num14 = double.Parse(playOddsInfo.Tables[0].Rows[0]["down_odds_rate"].ToString()) * num13;
                            CallBLL.cz_odds_xync_bll.UpdateGrandTotalCurrentOdds(num14.ToString(), (num11 - (num12 * num13)).ToString(), str11.ToString());
                            cz_system_log _log = new cz_system_log();
                            _log.set_user_name("系統");
                            _log.set_children_name("");
                            _log.set_category(playOddsInfo.Tables[0].Rows[0]["category"].ToString());
                            ...
                            num30 = double.Parse(str32) - num14;
                            _log.set_new_val(num30.ToString());
                            _log.set_ip(LSRequest.GetIP());
                            _log.set_add_time(DateTime.Now);
                            _log.set_note("系統自動降賠");
                            _log.set_type_id(Convert.ToInt32((LSEnums.LogTypeID) 0));
                            ...
                            num30 = double.Parse(str32) - num14;
                            _odds.set_new_odds(num30.ToString());
                            CallBLL.cz_jp_odds_bll.Add(_odds);
                        }
                        double num16 = 0.0;
                        double num17 = 0.0;
                        string[] strArray6 = str18.Split(new char[] { ',' });
                        num16 = double.Parse(strArray6[0].ToString());
                        if (strArray6.Length > 1)
                        {
                            num17 = double.Parse(strArray6[1].ToString());
                        }
                        string[] strArray7 = str22.Split(new char[] { ',' });
                        double.Parse(strArray7[0].ToString());
                        if (strArray7.Length > 1)
                        {
                            double.Parse(strArray7[1].ToString());
                        }
                        cz_splitgroup_xync _xync = new cz_splitgroup_xync();
                        _xync.set_odds_id(new int?(int.Parse(str11)));
                        _xync.set_item_money(new decimal?(Convert.ToDecimal(str12)));
                        _xync.set_odds1(new decimal?(Convert.ToDecimal(num16.ToString())));
                        _xync.set_odds2(new decimal?(Convert.ToDecimal(num17.ToString())));
                        _xync.set_bet_id(new int?(num9));
                        _xync.set_item(str7);
                        _xync.set_odds1_zj(new decimal?(Convert.ToDecimal(num16.ToString())));
                        _xync.set_odds2_zj(new decimal?(Convert.ToDecimal(num17.ToString())));
                        CallBLL.cz_splitgroup_xync_bll.Agent_AddSplitGroup(_xync);
                    ...
                    Label_174E:
                        ...
                        _kc2.set_play_name(playOddsInfo.Tables[0].Rows[0]["play_name"].ToString());
                        _kc2.set_play_id(new int?(int.Parse(playOddsInfo.Tables[0].Rows[0]["play_id"].ToString())));
                        _kc2.set_bet_val(str19);
                        _kc2.set_bet_wt("");
                        _kc2.set_odds(str18);
                    ...
                    Label_1CCF:
                        ...
                        int num18 = 0;
                        CallBLL.cz_bet_kc_bll.AddBetByBH(_kc2, ref num18);
                        double num19 = (double.Parse(str12) * num3) / 100.0;
                        CallBLL.cz_odds_xync_bll.Agent_UpdateGrandTotal(num19.ToString(), str11);
                        double num20 = double.Parse(playOddsInfo.Tables[0].Rows[0]["grand_total"].ToString()) + num19;
                        double num21 = double.Parse(playOddsInfo.Tables[0].Rows[0]["downbase"].ToString());
                        double num22 = Math.Floor((double) (num20 / num21));
                        if ((num22 >= 1.0) && (num21 >= 1.0))
                        {
                            double num23 = double.Parse(playOddsInfo.Tables[0].Rows[0]["down_odds_rate"].ToString()) * num22;
                            CallBLL.cz_odds_xync_bll.UpdateGrandTotalCurrentOdds(num23.ToString(), (num20 - (num21 * num22)).ToString(), str11.ToString());
                            ...
                            _log2.set_play_name(str20);
                            _log2.set_put_amount(str19);
                            _log2.set_l_name(LSKeys.get_XYNC_Name());
                            ...
                            num30 = double.Parse(str33) - num23;
                            _log2.set_new_val(num30.ToString());
                            ...
                            _odds2.set_play_name(str20);
                            _odds2.set_put_amount(str19);
                            _odds2.set_odds(num23.ToString());
                            _odds2.set_lottery_type(3);
                            _odds2.set_phase(phase);
                            _odds2.set_old_odds(str33);
                            _odds2.set_new_odds((double.Parse(str33) - num23).ToString());
                    ...
                    Label_20DF:
                        ...
                        {
                            string str34 = "";
                            str34 = (double.Parse(str12) * (double.Parse(str18) - 1.0)).ToString();
                            string str35 = "";
                            if (str7.Trim() != "")
                            {
                                str35 = str7;
                            ...
                            dictionary3.Add("playname", str20);
                            dictionary3.Add("ky", str34);
                            dictionary3.Add("putamount", str35);
                            dictionary3.Add("pl", str18.ToString());
                        ...
                        {
                            string str36 = "";
                            double num26 = double.Parse(str6) * (double.Parse(str18) - 1.0);
                            str36 = num26.ToString();
                            string str37 = str19;
        ...
        private void ZDBH(agent_userinfo_session userModel, agent_kc_rate kc_rate, string kc_kind, HttpContext context, string phase_id, string phase, string play_id, string odds_id, string zj_ds, string fgs_ds, string gd_ds, string zd_ds, string dl_ds, string hy_ds, string checkcode)
        {
            if (!string.IsNullOrEmpty(kc_rate.get_zdname()))
            {
                ...
                {
                    double num = 1.0;
                    DataTable autosale = CallBLL.cz_autosale_xync_bll.GetAutosale(kc_rate.get_zdname(), play_id);
                    if (((autosale != null) && (autosale.Rows.Count > 0)) && autosale.Rows[0]["sale_type"].ToString().Equals("0"))
                    {
                        DataTable table3 = CallBLL.cz_bet_kc_bll.GetSZZTBHByOddsid("zd", kc_rate.get_zdname(), odds_id, phase_id, 3);
                        if ((double.Parse(table3.Rows[0]["szzt"].ToString()) - num) > double.Parse(autosale.Rows[0]["max_money"].ToString()))
                        {
                            double num2 = double.Parse(table3.Rows[0]["szzt"].ToString());
                            double num3 = double.Parse(autosale.Rows[0]["max_money"].ToString());
        ...
        protected void ZDBH_LM(agent_userinfo_session userModel, agent_kc_rate kc_rate, string kc_kind, HttpContext context, string phase_id, string phase, string play_id, string odds_id, string zj_ds, string fgs_ds, string gd_ds, string zd_ds, string dl_ds, string hy_ds, string checkcode)
        {
            if (!string.IsNullOrEmpty(kc_rate.get_zdname()))
            {
                ...
                if ((isAllowSale.Rows[0]["kc_allow_sale"] != null) && (Convert.ToInt32(isAllowSale.Rows[0]["kc_allow_sale"]) != 0))
                {
                    ...
                    if (((autosale != null) && (autosale.Rows.Count > 0)) && autosale.Rows[0]["sale_type"].ToString().Equals("0"))
                    {
                        DataTable table3 = CallBLL.cz_bet_kc_bll.GetBHGroup("zd", kc_rate.get_zdname(), odds_id, phase_id, autosale.Rows[0]["max_money"].ToString(), num.ToString(), 3);
                        if ((table3 != null) && (table3.Rows.Count > 0))
                        {
                            dl_ds = zd_ds;
                            string s = kc_rate.get_zjzc();
