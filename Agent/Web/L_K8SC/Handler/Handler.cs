namespace Agent.Web.L_K8SC.Handler
{
    ...
    public class Handler : BaseHandler
    {
        ...
        private void FGSBH(agent_userinfo_session userModel, agent_kc_rate kc_rate, string kc_kind, HttpContext context, string phase_id, string phase, string play_id, string odds_id, string zj_ds, string fgs_ds, string gd_ds, string zd_ds, string dl_ds, string hy_ds, string checkcode)
        {
            if (!string.IsNullOrEmpty(kc_rate.get_fgsname()))
            {
                ...
                {
                    double num = 1.0;
                    DataTable autosale = CallBLL.cz_autosale_k8sc_bll.GetAutosale(kc_rate.get_fgsname(), play_id);
                    if (((autosale != null) && (autosale.Rows.Count > 0)) && autosale.Rows[0]["sale_type"].ToString().Equals("0"))
                    {
                        DataTable table3 = CallBLL.cz_bet_kc_bll.GetSZZTBHByOddsid("fgs", kc_rate.get_fgsname(), odds_id, phase_id, 6);
                        if ((double.Parse(table3.Rows[0]["szzt"].ToString()) - num) > double.Parse(autosale.Rows[0]["max_money"].ToString()))
                        {
                            ...
                            DataSet playOddsInfo = CallBLL.cz_play_k8sc_bll.GetPlayOddsInfo(odds_id);
                            ...
                            base.GetOdds_KC_EX(6, playOddsInfo.Tables[0].Rows[0]["current_odds"].ToString().Trim(), str2, ref s, odds_id);
                            ...
                            CallBLL.cz_odds_k8sc_bll.Agent_UpdateGrandTotal(num6.ToString(), odds_id);
                            ...
                            if ((num9 > 1.0) && (num8 >= 1.0))
                            {
                                ...
                                CallBLL.cz_odds_k8sc_bll.UpdateGrandTotalCurrentOdds(num10.ToString(), (num7 - (num8 * num9)).ToString(), odds_id.ToString());
                                ...
                                _log.set_l_name(LSKeys.get_K8SC_Name());
        ...
        private void GDBH(agent_userinfo_session userModel, agent_kc_rate kc_rate, string kc_kind, HttpContext context, string phase_id, string phase, string play_id, string odds_id, string zj_ds, string fgs_ds, string gd_ds, string zd_ds, string dl_ds, string hy_ds, string checkcode)
        {
            if (!string.IsNullOrEmpty(kc_rate.get_gdname()))
            {
                ...
                {
                    double num = 1.0;
                    DataTable autosale = CallBLL.cz_autosale_k8sc_bll.GetAutosale(kc_rate.get_gdname(), play_id);
                    if (((autosale != null) && (autosale.Rows.Count > 0)) && autosale.Rows[0]["sale_type"].ToString().Equals("0"))
                    {
                        DataTable table3 = CallBLL.cz_bet_kc_bll.GetSZZTBHByOddsid("gd", kc_rate.get_gdname(), odds_id, phase_id, 6);
                        if ((double.Parse(table3.Rows[0]["szzt"].ToString()) - num) > double.Parse(autosale.Rows[0]["max_money"].ToString()))
                        {
                            double num2 = double.Parse(table3.Rows[0]["szzt"].ToString());
                            double num3 = double.Parse(autosale.Rows[0]["max_money"].ToString());
                            ...
                            CallBLL.cz_odds_k8sc_bll.Agent_UpdateGrandTotal(num8.ToString(), odds_id);
                            ...
                            if ((num11 > 1.0) && (num10 >= 1.0))
                            {
                                ...
                                CallBLL.cz_odds_k8sc_bll.UpdateGrandTotalCurrentOdds(num12.ToString(), (num9 - (num10 * num11)).ToString(), odds_id.ToString());
                                cz_system_log _log = new cz_system_log();
                                _log.set_user_name("系統");
                                _log.set_children_name("");
                                _log.set_category(playOddsInfo.Tables[0].Rows[0]["category"].ToString());
        ...
        public void get_clyl(HttpContext context, ref string strResult)
        {
            ...
            {
                DataTable table = CallBLL.cz_phase_k8sc_bll.GetChangLong().Tables[0];
        ...
        public void get_oddsinfo(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataSet set = CallBLL.cz_play_k8sc_bll.Agent_GetPlay(str4, str10, str9, str7);
                if (set == null)
                {
                    context.Response.End();
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        Dictionary<string, object> dictionary2 = base.GetOdds_KC(6, oddsDT, str11, str12, null);
                        ...
                        DataSet set2 = CallBLL.cz_bet_kc_bll.GetSZSZ(str9, str10, int.Parse(s), Convert.ToInt32(str17), 6, str4, str21, model.get_zjname().ToString(), num, "k8sc", str6, null, null);
                        DataTable table4 = null;
                        if (str8.Equals("1"))
                        {
                            int num4 = 6;
                            table4 = CallBLL.cz_bet_kc_bll.GetBHSZZT(str10, str9, str17, str21, str4, model.get_zjname().ToString(), num, num4.ToString(), "k8sc", str6, null, null).Tables[0];
                        }
        ...
        public void get_opennumber(HttpContext context, ref string strResult)
        {
            ...
            {
                new List<object>();
                DataTable openNumber = base.GetOpenNumber(6, null);
                Dictionary<string, object> dictionary2 = new Dictionary<string, object>();
        ...
        public void operate_adds(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                string str12;
                double num39;
                cz_odds_k8sc oldModel = null;
                if ((str3.Equals("1") || str3.Equals("2")) || (str3.Equals("3") || str3.Equals("4")))
                {
                    oldModel = CallBLL.cz_odds_k8sc_bll.GetModel(Convert.ToInt32(str4));
                    if (oldModel == null)
                    {
                        result.set_success(400);
                        result.set_tipinfo(PageBase.GetMessageByCache("u100008", "MessageHint"));
                ...
                if (!str3.Equals("1") && !str3.Equals("2"))
                {
                    if (str3.Equals("3"))
                    {
                        ...
                        else if (CallBLL.cz_odds_k8sc_bll.UpdateCurrentOdds(Convert.ToInt32(str4), Convert.ToDouble(s), str3) > 0)
                        {
                            cz_odds_k8sc newModel = CallBLL.cz_odds_k8sc_bll.GetModel(Convert.ToInt32(str4));
                            base.k8sc_log(oldModel, newModel, str3);
                            ...
                            DataTable table2 = CallBLL.cz_phase_k8sc_bll.IsPhaseClose();
                    ...
                    else
                    {
                        ...
                        {
                            oldTable = CallBLL.cz_odds_k8sc_bll.GetOddsInfoByID(str4.ToString());
                        }
                        if (str3.Equals("5") || str3.Equals("6"))
                        {
                            ...
                            Label_0B71:
                                ...
                                if (CallBLL.cz_odds_k8sc_bll.UpdateCurrentOddsList(row["odds_id"].ToString(), str3.Equals("5") ? num24 : -num24, "5") > 0)
                                {
                                    num19++;
                                }
                            }
                            if (num19 > 0)
                            {
                                DataTable oddsInfoByID = CallBLL.cz_odds_k8sc_bll.GetOddsInfoByID(str4);
                                base.k8sc_kjj_log(oldTable, oddsInfoByID, str3);
                                ...
                                foreach (DataRow row2 in oddsInfoByID.Rows)
                                {
                                    ...
                                    DataTable table5 = CallBLL.cz_phase_k8sc_bll.IsPhaseClose();
                        ...
                        else if (str3.Equals("7"))
                        {
                            ...
                            foreach (DataRow row3 in oldTable.Rows)
                            {
                                ...
                                if (CallBLL.cz_odds_k8sc_bll.UpdateCurrentOddsList(row3["odds_id"].ToString(), num34, "7") > 0)
                                {
                                    num29++;
                                }
                            }
                            if (num29 > 0)
                            {
                                DataTable newTable = CallBLL.cz_odds_k8sc_bll.GetOddsInfoByID(str4);
                                base.k8sc_kjj_log(oldTable, newTable, str3);
                                ...
                                foreach (DataRow row4 in newTable.Rows)
                                {
                                    ...
                                    DataTable table7 = CallBLL.cz_phase_k8sc_bll.IsPhaseClose();
                ...
                else
                {
                    ...
                    else if (CallBLL.cz_odds_k8sc_bll.UpdateCurrentOdds(Convert.ToInt32(str4), str3.Equals("1") ? Convert.ToDouble(str6) : -Convert.ToDouble(str6), str3) > 0)
                    {
                        cz_odds_k8sc _ksc2 = CallBLL.cz_odds_k8sc_bll.GetModel(Convert.ToInt32(str4));
                        base.k8sc_log(oldModel, _ksc2, str3);
                        double num7 = Convert.ToDouble(_ksc2.get_current_odds());
                        double num8 = Convert.ToDouble(_ksc2.get_max_odds());
                        double num9 = Convert.ToDouble(_ksc2.get_min_odds());
                        double num10 = 0.0;
                        if (str5.Equals("A"))
                        {
                            num10 = Convert.ToDouble(_ksc2.get_a_diff());
                        }
                        else if (str5.Equals("B"))
                        {
                            num10 = Convert.ToDouble(_ksc2.get_b_diff());
                        }
                        else if (str5.Equals("C"))
                        {
                            num10 = Convert.ToDouble(_ksc2.get_c_diff());
                        }
                        num39 = num7 + num10;
                        num7 = double.Parse(num39.ToString());
                        string str8 = _ksc2.get_is_open().ToString();
                        Dictionary<string, object> dictionary2 = new Dictionary<string, object>();
                        Dictionary<string, object> dictionary3 = new Dictionary<string, object>();
                        ...
                        DataTable table = CallBLL.cz_phase_k8sc_bll.IsPhaseClose();
        ...
        public void operate_CloseOpen(HttpContext context, ref string strResult)
        {
            ...
            if (str3.Equals("4"))
            {
                ...
                else
                {
                    ...
                    {
                        int num = CallBLL.cz_odds_k8sc_bll.UpdateIsOpen(Convert.ToInt32(str4));
                        result.set_success(200);
                        if (num > 0)
                        {
                            base.kc_openclose_log(str4, str3, str5, 6, LSRequest.qq("playpage"));
                            strResult = JsonHandle.ObjectToJson(result);
                        }
                        else
                        {
            ...
            else if (str3.Equals("8"))
            {
                ...
                else
                {
                    ...
                    {
                        int num2 = CallBLL.cz_odds_k8sc_bll.UpdateIsOpenList(str4, Convert.ToInt32(str5));
                        result.set_success(200);
                        if (num2 > 0)
                        {
                            base.kc_openclose_log(str4, str3, str5, 6, LSRequest.qq("playpage"));
            ...
            else if (str3.Equals("61") || str3.Equals("62"))
            {
                ...
                {
                    int num3 = CallBLL.cz_odds_k8sc_bll.UpdateIsOpenList(str3, str6, str4, str5);
                    result.set_success(200);
                    if (num3 > 0)
                    {
                        base.kc_openclose_log(str4, str3, str5, 6, LSRequest.qq("playpage"));
        ...
        public void operate_odds_wt(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                {
                    _ksc = CallBLL.cz_odds_k8sc_bll.GetModel(Convert.ToInt32(str4));
                    if (_ksc == null)
                    {
                        result.set_success(400);
                        result.set_tipinfo(PageBase.GetMessageByCache("u100008", "MessageHint"));
                ...
                if (!str3.Equals("1") && !str3.Equals("2"))
                {
                    if (str3.Equals("3"))
                    {
                        double num16 = double.Parse(_ksc.get_current_odds());
                        double num17 = Convert.ToDouble(_ksc.get_max_odds());
                        double num18 = Convert.ToDouble(_ksc.get_min_odds());
                        double num19 = 0.0;
                        if (str8.Equals("A"))
                        {
                            num19 = Convert.ToDouble(_ksc.get_a_diff());
                        }
                        else if (str8.Equals("B"))
                        {
                            num19 = Convert.ToDouble(_ksc.get_b_diff());
                        }
                        else if (str8.Equals("C"))
                        {
                            num19 = Convert.ToDouble(_ksc.get_c_diff());
                        }
                        base.GetFgsWTTable(6);
                        double wtvalue = 0.0;
                        base.GetOperate_KC(6, str4, ref wtvalue);
                        double num21 = num16;
                        double num22 = num18;
                        num60 = num16 + wtvalue;
                        ...
                        if (Convert.ToDouble(s) < num22)
                        {
                            result.set_success(400);
                            num60 = num22 + num19;
                            result.set_tipinfo(string.Format(PageBase.GetMessageByCache("u100023", "MessageHint"), _ksc.get_play_name() + "【" + _ksc.get_put_amount() + "】", double.Parse(num60.ToString())));
                            strResult = JsonHandle.ObjectToJson(result);
                        }
                        else if (Convert.ToDouble(s) > num21)
                        {
                            result.set_success(400);
                            num60 = num21 + num19;
                            result.set_tipinfo(string.Format(PageBase.GetMessageByCache("u100055", "MessageHint"), _ksc.get_play_name() + "【" + _ksc.get_put_amount() + "】", double.Parse(num60.ToString())));
                            strResult = JsonHandle.ObjectToJson(result);
                        }
                        ...
                        else
                        {
                            ...
                            DataTable oddsWTbyFGS = CallBLL.cz_odds_wt_k8sc_bll.GetOddsWTbyFGS(str4, str);
                            num61 = 6;
                            base.Add_FgsOddsWT_Lock(num61.ToString(), str, str4);
                            int num27 = CallBLL.cz_odds_wt_k8sc_bll.UpdateFgsWTOdds(Convert.ToInt32(str4), num26, str3, str);
                            num61 = 6;
                            base.Del_FgsOddsWT_Lock(num61.ToString(), str, str4);
                            if (num27 > 0)
                            {
                                wtvalue = 0.0;
                                CacheHelper.RemoveAllCache("fgs_wt_FileCacheKey" + context.Session["user_name"].ToString() + 6);
                                FileCacheHelper.UpdateFGSWTFile(6);
                                base.GetOperate_KC(6, str4, ref wtvalue);
                                cz_odds_k8sc _ksc3 = CallBLL.cz_odds_k8sc_bll.GetModel(Convert.ToInt32(str4));
                                base.fgs_opt_kc_log(oddsWTbyFGS, CallBLL.cz_odds_wt_k8sc_bll.GetOddsWTbyFGS(str4, str), str3, str, str4, 6);
                                double num28 = Convert.ToDouble(_ksc3.get_current_odds());
                                Convert.ToDouble(_ksc3.get_max_odds());
                                double num29 = Convert.ToDouble(_ksc3.get_min_odds());
                                double num30 = 0.0;
                                if (str8.Equals("A"))
                                {
                                    num30 = Convert.ToDouble(_ksc3.get_a_diff());
                                }
                                else if (str8.Equals("B"))
                                {
                                    num30 = Convert.ToDouble(_ksc3.get_b_diff());
                                }
                                else if (str8.Equals("C"))
                                {
                                    num30 = Convert.ToDouble(_ksc3.get_c_diff());
                                }
                                ...
                                string str10 = _ksc3.get_is_open().ToString();
                                Dictionary<string, object> dictionary4 = new Dictionary<string, object>();
                                Dictionary<string, object> dictionary5 = new Dictionary<string, object>();
                                ...
                                dictionary5.Add("plx", new List<double>());
                                DataTable table4 = CallBLL.cz_phase_k8sc_bll.IsPhaseClose();
                    ...
                    else
                    {
                        ...
                        if ((str3.Equals("5") || str3.Equals("6")) || str3.Equals("7"))
                        {
                            oddsInfoByID = CallBLL.cz_odds_k8sc_bll.GetOddsInfoByID(str4.ToString());
                        }
                        if (str3.Equals("5") || str3.Equals("6"))
                        {
                            if (string.IsNullOrEmpty(str6))
                            ...
                            foreach (DataRow row in oddsInfoByID.Rows)
                            {
                                ...
                                base.GetFgsWTTable(6);
                                double num35 = 0.0;
                                base.GetOperate_KC(6, row["odds_id"].ToString(), ref num35);
                                num60 = num32 + num35;
                            ...
                            Label_1087:
                                ...
                                DataTable table6 = CallBLL.cz_odds_wt_k8sc_bll.GetOddsWTbyFGS(str4, str);
                                num61 = 6;
                                base.Add_FgsOddsWT_Lock(num61.ToString(), str, row["odds_id"].ToString());
                                int num40 = CallBLL.cz_odds_wt_k8sc_bll.UpdateFgsWTOddsList(row["odds_id"].ToString(), str3.Equals("5") ? Convert.ToDecimal(num39) : -Convert.ToDecimal(num39), "5", str);
                                num61 = 6;
                                base.Del_FgsOddsWT_Lock(num61.ToString(), str, row["odds_id"].ToString());
                                if (num40 > 0)
                                {
                                    base.fgs_opt_kc_log(table6, CallBLL.cz_odds_wt_k8sc_bll.GetOddsWTbyFGS(str4, str), str3, str, str4, 6);
                                    num31++;
                                }
                            }
                            if (num31 > 0)
                            {
                                CacheHelper.RemoveAllCache("fgs_wt_FileCacheKey" + context.Session["user_name"].ToString() + 6);
                                FileCacheHelper.UpdateFGSWTFile(6);
                                DataTable table7 = CallBLL.cz_odds_k8sc_bll.GetOddsInfoByID(str4);
                                Dictionary<string, object> dictionary6 = new Dictionary<string, object>();
                                foreach (DataRow row2 in table7.Rows)
                                {
                                    double num41 = 0.0;
                                    base.GetOperate_KC(6, row2["odds_id"].ToString(), ref num41);
                                    cz_odds_k8sc _ksc4 = CallBLL.cz_odds_k8sc_bll.GetModel(Convert.ToInt32(row2["odds_id"].ToString()));
                                    double num42 = Convert.ToDouble(_ksc4.get_current_odds());
                                    double num43 = Convert.ToDouble(_ksc4.get_max_odds());
                                    double num44 = Convert.ToDouble(_ksc4.get_min_odds());
                                    double num45 = 0.0;
                                    if (str8.Equals("A"))
                                    {
                                        num45 = Convert.ToDouble(_ksc4.get_a_diff());
                                    }
                                    else if (str8.Equals("B"))
                                    {
                                        num45 = Convert.ToDouble(_ksc4.get_b_diff());
                                    }
                                    else if (str8.Equals("C"))
                                    {
                                        num45 = Convert.ToDouble(_ksc4.get_c_diff());
                                    }
                                    num60 = num42 + num45;
                                    ...
                                    dictionary7.Add("plx", new List<double>());
                                    DataTable table8 = CallBLL.cz_phase_k8sc_bll.IsPhaseClose();
                        ...
                        else if (str3.Equals("7"))
                        {
                            ...
                            foreach (DataRow row3 in oddsInfoByID.Rows)
                            {
                                ...
                                base.GetFgsWTTable(6);
                                double num49 = 0.0;
                                base.GetOperate_KC(6, row3["odds_id"].ToString(), ref num49);
                                num60 = num46 + num49;
                                double.Parse(num60.ToString());
                                num60 = num46 + num48;
                                double.Parse(num60.ToString());
                            ...
                            DataTable table9 = CallBLL.cz_odds_wt_k8sc_bll.GetOddsWTbyFGS(str4, str);
                            num61 = 6;
                            base.Add_FgsOddsWT_Lock(num61.ToString(), str, str4);
                            int num54 = CallBLL.cz_odds_wt_k8sc_bll.UpdateFgsWTOddsInputList(str4, dictionary8, str);
                            num61 = 6;
                            base.Del_FgsOddsWT_Lock(num61.ToString(), str, str4);
                            if (num54 > 0)
                            {
                                CacheHelper.RemoveAllCache("fgs_wt_FileCacheKey" + context.Session["user_name"].ToString() + 6);
                                FileCacheHelper.UpdateFGSWTFile(6);
                                DataTable table10 = CallBLL.cz_odds_k8sc_bll.GetOddsInfoByID(str4);
                                base.fgs_opt_kc_log(table9, CallBLL.cz_odds_wt_k8sc_bll.GetOddsWTbyFGS(str4, str), str3, str, str4, 6);
                                Dictionary<string, object> dictionary9 = new Dictionary<string, object>();
                                foreach (DataRow row4 in table10.Rows)
                                {
                                    double num55 = 0.0;
                                    base.GetOperate_KC(6, row4["odds_id"].ToString(), ref num55);
                                    ...
                                    DataTable table11 = CallBLL.cz_phase_k8sc_bll.IsPhaseClose();
                ...
                {
                    double num = double.Parse(_ksc.get_current_odds());
                    double num2 = Convert.ToDouble(_ksc.get_max_odds());
                    double num3 = Convert.ToDouble(_ksc.get_min_odds());
                    double num4 = 0.0;
                    if (str8.Equals("A"))
                    {
                        num4 = Convert.ToDouble(_ksc.get_a_diff());
                    }
                    else if (str8.Equals("B"))
                    {
                        num4 = Convert.ToDouble(_ksc.get_b_diff());
                    }
                    else if (str8.Equals("C"))
                    {
                        num4 = Convert.ToDouble(_ksc.get_c_diff());
                    }
                    base.GetFgsWTTable(6);
                    double num5 = 0.0;
                    base.GetOperate_KC(6, str4, ref num5);
                    double num6 = num;
                    double num7 = num3;
                    num60 = num + num5;
                    ...
                    {
                        DataTable table = CallBLL.cz_odds_wt_k8sc_bll.GetOddsWTbyFGS(str4, str);
                        num61 = 6;
                        base.Add_FgsOddsWT_Lock(num61.ToString(), str, str4);
                        int num12 = CallBLL.cz_odds_wt_k8sc_bll.UpdateFgsWTOdds(Convert.ToInt32(str4), str3.Equals("1") ? decimal.Parse(str6) : -decimal.Parse(str6), str3, str);
                        base.Del_FgsOddsWT_Lock(6.ToString(), str, str4);
                        if (num12 > 0)
                        {
                            num5 = 0.0;
                            CacheHelper.RemoveAllCache("fgs_wt_FileCacheKey" + context.Session["user_name"].ToString() + 6);
                            ...
                            base.GetOperate_KC(6, str4, ref num5);
                            cz_odds_k8sc _ksc2 = CallBLL.cz_odds_k8sc_bll.GetModel(Convert.ToInt32(str4));
                            base.fgs_opt_kc_log(table, CallBLL.cz_odds_wt_k8sc_bll.GetOddsWTbyFGS(str4, str), str3, str, str4, 6);
                            double num13 = Convert.ToDouble(_ksc2.get_current_odds());
                            Convert.ToDouble(_ksc2.get_max_odds());
                            double num14 = Convert.ToDouble(_ksc2.get_min_odds());
                            double num15 = 0.0;
                            if (str8.Equals("A"))
                            {
                                num15 = Convert.ToDouble(_ksc2.get_a_diff());
                            }
                            else if (str8.Equals("B"))
                            {
                                num15 = Convert.ToDouble(_ksc2.get_b_diff());
                            }
                            else if (str8.Equals("C"))
                            {
                                num15 = Convert.ToDouble(_ksc2.get_c_diff());
                            }
                            ...
                            string str9 = _ksc2.get_is_open().ToString();
                            Dictionary<string, object> dictionary2 = new Dictionary<string, object>();
                            Dictionary<string, object> dictionary3 = new Dictionary<string, object>();
        ...
        public void user_allow_sale(HttpContext context, ref string strResult)
        {
            ...
            else
            {
                ...
                DataTable phaseByPID = CallBLL.cz_phase_k8sc_bll.GetPhaseByPID(s);
                ...
                else
                {
                    ...
                    while (num14 < strArray4.Length)
                    {
                        ...
                        if (flag)
                        {
                            ...
                            int num16 = 6;
                            table2 = CallBLL.cz_bet_kc_bll.GetSZZT(model.get_u_name(), model.get_u_type().Trim(), str4, s, true, str7, num16.ToString(), "k8sc");
                        }
                        else
                        {
                            table2 = CallBLL.cz_bet_kc_bll.GetSZZT(model.get_u_name(), model.get_u_type().Trim(), str4, s, false, "", 6.ToString(), "k8sc");
                        }
                        ...
                        DataTable table3 = base.GetUserDrawback_k8sc();
                        string str16 = "A";
                        ...
                        DataSet playOddsInfo = CallBLL.cz_play_k8sc_bll.GetPlayOddsInfo(str11);
                        ...
                        base.GetOdds_KC_EX(6, playOddsInfo.Tables[0].Rows[0]["current_odds"].ToString().Trim(), str21, ref str19, str11);
                    ...
                    Label_10FF:
                        ...
                        CallBLL.cz_odds_k8sc_bll.Agent_UpdateGrandTotal(num7.ToString(), str11);
                        ...
                        if ((num10 >= 1.0) && (num9 >= 1.0))
                        {
                            ...
                            CallBLL.cz_odds_k8sc_bll.UpdateGrandTotalCurrentOdds(num11.ToString(), (num8 - (num9 * num10)).ToString(), str11.ToString());
                            cz_system_log _log = new cz_system_log();
                            _log.set_user_name("系統");
                            _log.set_children_name("");
                            _log.set_category(playOddsInfo.Tables[0].Rows[0]["category"].ToString());
        ...
        private void ZDBH(agent_userinfo_session userModel, agent_kc_rate kc_rate, string kc_kind, HttpContext context, string phase_id, string phase, string play_id, string odds_id, string zj_ds, string fgs_ds, string gd_ds, string zd_ds, string dl_ds, string hy_ds, string checkcode)
        {
            if (!string.IsNullOrEmpty(kc_rate.get_zdname()))
            {
                ...
                {
                    double num = 1.0;
                    DataTable autosale = CallBLL.cz_autosale_k8sc_bll.GetAutosale(kc_rate.get_zdname(), play_id);
                    if (((autosale != null) && (autosale.Rows.Count > 0)) && autosale.Rows[0]["sale_type"].ToString().Equals("0"))
                    {
                        DataTable table3 = CallBLL.cz_bet_kc_bll.GetSZZTBHByOddsid("zd", kc_rate.get_zdname(), odds_id, phase_id, 6);
                        if ((double.Parse(table3.Rows[0]["szzt"].ToString()) - num) > double.Parse(autosale.Rows[0]["max_money"].ToString()))
                        {
                            double num2 = double.Parse(table3.Rows[0]["szzt"].ToString());
                            double num3 = double.Parse(autosale.Rows[0]["max_money"].ToString());
