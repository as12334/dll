namespace Agent.Web.L_PKBJL
{
    ...
    public class Betimes_2 : MemberPageBase
    {
        ...
        Label_00B5:
            ...
            CookieHelper.SetCookie("PKBJL_TableType_Record_Current_Agent", this.playpage);
            this.Session["PKBJL_TableType_Record_Current_Agent"] = this.playpage;
        }
    }
}
