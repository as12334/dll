namespace Agent.Web.L_SPEED5
{
    ...
    public class Betimes_zx : MemberPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.userType = "0";
        Label_00B5:
            this.userType = this.uModel.get_u_type().Trim().Equals("zj") ? "1" : "0";
