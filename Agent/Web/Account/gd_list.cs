namespace Agent.Web.Account
{
    ...
    public class gd_list : MemberPageBase
    {
        ...
        {
            foreach (DataRow row in CallBLL.cz_rate_kc_bll.GetUserCount(u_name, "gd").Rows)
            {
        ...
        {
            DataTable uIDByUpUserName = CallBLL.cz_users_bll.GetUIDByUpUserName("gd", u_name);
