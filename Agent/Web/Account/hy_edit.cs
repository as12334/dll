namespace Agent.Web.Account
{
    ...
    public class hy_edit : MemberPageBase
    {
        ...
        protected string d_up_u_typeText = "";
        ...
        private void InitData()
        {
            ...
            if (str != null)
            {
                if (!(str == "fgs"))
                {
                    if (str == "gd")
                    {
                        this.d_up_u_typeText = "股東";
                        goto Label_034E;
                    }
                    if (str == "zd")
                    {
                        this.d_up_u_typeText = "總代";
                        goto Label_034E;
                    }
                }
                else
                {
                    this.d_up_u_typeText = "分公司";
                    goto Label_034E;
                }
            }
            this.d_up_u_typeText = "代理";
        Label_034E:
            this.d_up_six_allow_sale = dictionary["six_allow_sale"];
            this.d_up_six_usable_credit = dictionary["six_usable_credit"];
            this.d_up_six_kind = dictionary["six_kind"];
            ...
            this.d_up_kc_kind = dictionary2["kc_kind"];
