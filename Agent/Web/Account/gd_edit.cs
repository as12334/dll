namespace Agent.Web.Account
{
    ...
    public class gd_edit : MemberPageBase
    {
        ...
        private void AddUser()
        {
            ...
            string message = "";
            if (!base.ValidParamByUserEdit("gd", ref message, null, this.lottrty_six, this.lottrty_kc))
            {
            ...
            if (CallBLL.cz_users_bll.UpdateUserInfo(_users, flag2, flag3, flag4, flag5, this.d_up_u_type, this.d_up_u_name))
            {
                ...
                base.Un_User_Lock(rateKCByUserName.get_fgs_name());
                base.Response.Write(base.ShowDialogBox("修改股東成功！", base.UserReturnBackUrl, 0));
                base.Response.End();
            }
            else
            {
                base.Un_User_Lock(rateKCByUserName.get_fgs_name());
                base.Response.Write(base.ShowDialogBox("修改股東失敗！", base.UserReturnBackUrl, 400));
                base.Response.End();
            }
        }
