namespace Agent.Web.Account
{
    ...
    public class gd_add : MemberPageBase
    {
        ...
        private void AddUser()
        {
            ...
            {
                base.Un_User_Lock(rateKCByUserName.get_fgs_name());
                base.Response.Write(base.ShowDialogBox("⑥合彩: 分公司占成 不可高於" + this.six_rate_d + "，請修改！", null, 400));
                base.Response.End();
            }
            if (str6.Equals("1"))
            {
            ...
            {
                base.Un_User_Lock(rateKCByUserName.get_fgs_name());
                base.Response.Write(base.ShowDialogBox("快彩: 分公司占成 不可高於" + this.kc_rate_d + "，請修改！", null, 400));
                base.Response.End();
            }
            if (str11.Equals("1"))
            {
            ...
            if (CallBLL.cz_users_bll.AddUserInfo(model, _kc2, _six, ref str19))
            {
                ...
                base.Response.Write(base.ShowDialogBox("添加股東成功！", url, 0));
                base.Response.End();
            }
            else
            {
                base.Un_User_Lock(rateKCByUserName.get_fgs_name());
                base.Response.Write(base.ShowDialogBox("添加股東失敗！", base.UserReturnBackUrl, 400));
                base.Response.End();
            }
        }
