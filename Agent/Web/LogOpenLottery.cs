namespace Agent.Web
{
    ...
    public class LogOpenLottery : MemberPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet set = CallBLL.cz_lotteryopen_log_bll.GetLogByPage(Convert.ToInt32(this.page) - 1, this.pageSize, ref this.pageCount, ref this.dataCount, (this.lotteryId == "") ? "" : this.lotteryId, this.phaseNum);
