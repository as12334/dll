...
public class m_touzhu_15 : MemberPageBase_Mobile
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.r_url = "JSFT2_" + this.wanfa + ".aspx?lottery_type=" + this.caizhong + "&player_type=" + this.wanfa;
        DataTable table = CallBLL.cz_phase_jsft2_bll.GetIsClosedByTime(int.Parse(this.jiangqi)).Tables[0];
        ...
        DataSet playOddsByID = CallBLL.cz_odds_jsft2_bll.GetPlayOddsByID(str2);
